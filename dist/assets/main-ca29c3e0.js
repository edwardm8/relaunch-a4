...
`)+`
`+d);const _=y+p+o,T=y+d+a,A=wa(r,r.VERTEX_SHADER,_),R=wa(r,r.FRAGMENT_SHADER,T);if(r.attachShader(v,A),r.attachShader(v,R),t.index0AttributeName!==void 0?r.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(v,0,"position"),r.linkProgram(v),i.debug.checkShaderErrors){const M=r.getProgramInfoLog(v).trim(),w=r.getShaderInfoLog(A).trim(),q=r.getShaderInfoLog(R).trim();let ie=!0,F=!0;if(r.getProgramParameter(v,r.LINK_STATUS)===!1)if(ie=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,v,A,R);else{const G=Ra(r,A,"vertex"),H=Ra(r,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(v,r.VALIDATE_STATUS)+`

Program Info Log: `+M+`
`+G+`
`+H)}else M!==""?console.warn("THREE.WebGLProgram: Program Info Log:",M):(w===""||q==="")&&(F=!1);F&&(this.diagnostics={runnable:ie,programLog:M,vertexShader:{log:w,prefix:p},fragmentShader:{log:q,prefix:d}})}r.deleteShader(A),r.deleteShader(R);let P;this.getUniforms=function(){return P===void 0&&(P=new ji(r,v)),P};let D;return this.getAttributes=function(){return D===void 0&&(D=nd(r,v)),D},this.destroy=function(){n.releaseStatesOfProgram(this),r.deleteProgram(v),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=Kf++,this.cacheKey=e,this.usedTimes=1,this.program=v,this.vertexShader=A,this.fragmentShader=R,this}let dd=0;class pd{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,n=e.fragmentShader,r=this._getShaderStage(t),s=this._getShaderStage(n),o=this._getShaderCacheForMaterial(e);return o.has(r)===!1&&(o.add(r),r.usedTimes++),o.has(s)===!1&&(o.add(s),s.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new md(e),t.set(e,n)),n}}class md{constructor(e){this.id=dd++,this.code=e,this.usedTimes=0}}function gd(i,e,t,n,r,s,o){const a=new lo,l=new pd,c=[],u=r.isWebGL2,h=r.logarithmicDepthBuffer,f=r.vertexTextures;let m=r.precision;const g={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function v(M){return M===0?"uv":`uv${M}`}function p(M,w,q,ie,F){const G=ie.fog,H=F.geometry,ee=M.isMeshStandardMaterial?ie.environment:null,X=(M.isMeshStandardMaterial?t:e).get(M.envMap||ee),Y=X&&X.mapping===Qi?X.image.height:null,K=g[M.type];M.precision!==null&&(m=r.getMaxPrecision(M.precision),m!==M.precision&&console.warn("THREE.WebGLProgram.getParameters:",M.precision,"not supported, using",m,"instead."));const j=H.morphAttributes.position||H.morphAttributes.normal||H.morphAttributes.color,fe=j!==void 0?j.length:0;let z=0;H.morphAttributes.position!==void 0&&(z=1),H.morphAttributes.normal!==void 0&&(z=2),H.morphAttributes.color!==void 0&&(z=3);let J,$,ce,le;if(K){const Ke=It[K];J=Ke.vertexShader,$=Ke.fragmentShader}else J=M.vertexShader,$=M.fragmentShader,l.update(M),ce=l.getVertexShaderID(M),le=l.getFragmentShaderID(M);const ve=i.getRenderTarget(),Le=F.isInstancedMesh===!0,Ee=!!M.map,Ye=!!M.matcap,Ne=!!X,I=!!M.aoMap,$e=!!M.lightMap,xe=!!M.bumpMap,Re=!!M.normalMap,Me=!!M.displacementMap,He=!!M.emissiveMap,De=!!M.metalnessMap,be=!!M.roughnessMap,Ge=M.anisotropy>0,Qe=M.clearcoat>0,nt=M.iridescence>0,E=M.sheen>0,x=M.transmission>0,V=Ge&&!!M.anisotropyMap,ne=Qe&&!!M.clearcoatMap,te=Qe&&!!M.clearcoatNormalMap,b=Qe&&!!M.clearcoatRoughnessMap,Z=nt&&!!M.iridescenceMap,Q=nt&&!!M.iridescenceThicknessMap,B=E&&!!M.sheenColorMap,de=E&&!!M.sheenRoughnessMap,_e=!!M.specularMap,ge=!!M.specularColorMap,me=!!M.specularIntensityMap,ue=x&&!!M.transmissionMap,ye=x&&!!M.thicknessMap,Oe=!!M.gradientMap,C=!!M.alphaMap,ae=M.alphaTest>0,O=!!M.extensions,re=!!H.attributes.uv1,oe=!!H.attributes.uv2,ze=!!H.attributes.uv3;return{isWebGL2:u,shaderID:K,shaderType:M.type,shaderName:M.name,vertexShader:J,fragmentShader:$,defines:M.defines,customVertexShaderID:ce,customFragmentShaderID:le,isRawShaderMaterial:M.isRawShaderMaterial===!0,glslVersion:M.glslVersion,precision:m,instancing:Le,instancingColor:Le&&F.instanceColor!==null,supportsVertexTextures:f,outputColorSpace:ve===null?i.outputColorSpace:ve.isXRRenderTarget===!0?ve.texture.colorSpace:Ut,map:Ee,matcap:Ye,envMap:Ne,envMapMode:Ne&&X.mapping,envMapCubeUVHeight:Y,aoMap:I,lightMap:$e,bumpMap:xe,normalMap:Re,displacementMap:f&&Me,emissiveMap:He,normalMapObjectSpace:Re&&M.normalMapType===Ac,normalMapTangentSpace:Re&&M.normalMapType===io,metalnessMap:De,roughnessMap:be,anisotropy:Ge,anisotropyMap:V,clearcoat:Qe,clearcoatMap:ne,clearcoatNormalMap:te,clearcoatRoughnessMap:b,iridescence:nt,iridescenceMap:Z,iridescenceThicknessMap:Q,sheen:E,sheenColorMap:B,sheenRoughnessMap:de,specularMap:_e,specularColorMap:ge,specularIntensityMap:me,transmission:x,transmissionMap:ue,thicknessMap:ye,gradientMap:Oe,opaque:M.transparent===!1&&M.blending===jn,alphaMap:C,alphaTest:ae,combine:M.combine,mapUv:Ee&&v(M.map.channel),aoMapUv:I&&v(M.aoMap.channel),lightMapUv:$e&&v(M.lightMap.channel),bumpMapUv:xe&&v(M.bumpMap.channel),normalMapUv:Re&&v(M.normalMap.channel),displacementMapUv:Me&&v(M.displacementMap.channel),emissiveMapUv:He&&v(M.emissiveMap.channel),metalnessMapUv:De&&v(M.metalnessMap.channel),roughnessMapUv:be&&v(M.roughnessMap.channel),anisotropyMapUv:V&&v(M.anisotropyMap.channel),clearcoatMapUv:ne&&v(M.clearcoatMap.channel),clearcoatNormalMapUv:te&&v(M.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:b&&v(M.clearcoatRoughnessMap.channel),iridescenceMapUv:Z&&v(M.iridescenceMap.channel),iridescenceThicknessMapUv:Q&&v(M.iridescenceThicknessMap.channel),sheenColorMapUv:B&&v(M.sheenColorMap.channel),sheenRoughnessMapUv:de&&v(M.sheenRoughnessMap.channel),specularMapUv:_e&&v(M.specularMap.channel),specularColorMapUv:ge&&v(M.specularColorMap.channel),specularIntensityMapUv:me&&v(M.specularIntensityMap.channel),transmissionMapUv:ue&&v(M.transmissionMap.channel),thicknessMapUv:ye&&v(M.thicknessMap.channel),alphaMapUv:C&&v(M.alphaMap.channel),vertexTangents:!!H.attributes.tangent&&(Re||Ge),vertexColors:M.vertexColors,vertexAlphas:M.vertexColors===!0&&!!H.attributes.color&&H.attributes.color.itemSize===4,vertexUv1s:re,vertexUv2s:oe,vertexUv3s:ze,pointsUvs:F.isPoints===!0&&!!H.attributes.uv&&(Ee||C),fog:!!G,useFog:M.fog===!0,fogExp2:G&&G.isFogExp2,flatShading:M.flatShading===!0,sizeAttenuation:M.sizeAttenuation===!0,logarithmicDepthBuffer:h,skinning:F.isSkinnedMesh===!0,morphTargets:H.morphAttributes.position!==void 0,morphNormals:H.morphAttributes.normal!==void 0,morphColors:H.morphAttributes.color!==void 0,morphTargetsCount:fe,morphTextureStride:z,numDirLights:w.directional.length,numPointLights:w.point.length,numSpotLights:w.spot.length,numSpotLightMaps:w.spotLightMap.length,numRectAreaLights:w.rectArea.length,numHemiLights:w.hemi.length,numDirLightShadows:w.directionalShadowMap.length,numPointLightShadows:w.pointShadowMap.length,numSpotLightShadows:w.spotShadowMap.length,numSpotLightShadowsWithMaps:w.numSpotLightShadowsWithMaps,numClippingPlanes:o.numPlanes,numClipIntersection:o.numIntersection,dithering:M.dithering,shadowMapEnabled:i.shadowMap.enabled&&q.length>0,shadowMapType:i.shadowMap.type,toneMapping:M.toneMapped?i.toneMapping:Jt,useLegacyLights:i.useLegacyLights,premultipliedAlpha:M.premultipliedAlpha,doubleSided:M.side===Zt,flipSided:M.side===pt,useDepthPacking:M.depthPacking>=0,depthPacking:M.depthPacking||0,index0AttributeName:M.index0AttributeName,extensionDerivatives:O&&M.extensions.derivatives===!0,extensionFragDepth:O&&M.extensions.fragDepth===!0,extensionDrawBuffers:O&&M.extensions.drawBuffers===!0,extensionShaderTextureLOD:O&&M.extensions.shaderTextureLOD===!0,rendererExtensionFragDepth:u||n.has("EXT_frag_depth"),rendererExtensionDrawBuffers:u||n.has("WEBGL_draw_buffers"),rendererExtensionShaderTextureLod:u||n.has("EXT_shader_texture_lod"),customProgramCacheKey:M.customProgramCacheKey()}}function d(M){const w=[];if(M.shaderID?w.push(M.shaderID):(w.push(M.customVertexShaderID),w.push(M.customFragmentShaderID)),M.defines!==void 0)for(const q in M.defines)w.push(q),w.push(M.defines[q]);return M.isRawShaderMaterial===!1&&(y(w,M),_(w,M),w.push(i.outputColorSpace)),w.push(M.customProgramCacheKey),w.join()}function y(M,w){M.push(w.precision),M.push(w.outputColorSpace),M.push(w.envMapMode),M.push(w.envMapCubeUVHeight),M.push(w.mapUv),M.push(w.alphaMapUv),M.push(w.lightMapUv),M.push(w.aoMapUv),M.push(w.bumpMapUv),M.push(w.normalMapUv),M.push(w.displacementMapUv),M.push(w.emissiveMapUv),M.push(w.metalnessMapUv),M.push(w.roughnessMapUv),M.push(w.anisotropyMapUv),M.push(w.clearcoatMapUv),M.push(w.clearcoatNormalMapUv),M.push(w.clearcoatRoughnessMapUv),M.push(w.iridescenceMapUv),M.push(w.iridescenceThicknessMapUv),M.push(w.sheenColorMapUv),M.push(w.sheenRoughnessMapUv),M.push(w.specularMapUv),M.push(w.specularColorMapUv),M.push(w.specularIntensityMapUv),M.push(w.transmissionMapUv),M.push(w.thicknessMapUv),M.push(w.combine),M.push(w.fogExp2),M.push(w.sizeAttenuation),M.push(w.morphTargetsCount),M.push(w.morphAttributeCount),M.push(w.numDirLights),M.push(w.numPointLights),M.push(w.numSpotLights),M.push(w.numSpotLightMaps),M.push(w.numHemiLights),M.push(w.numRectAreaLights),M.push(w.numDirLightShadows),M.push(w.numPointLightShadows),M.push(w.numSpotLightShadows),M.push(w.numSpotLightShadowsWithMaps),M.push(w.shadowMapType),M.push(w.toneMapping),M.push(w.numClippingPlanes),M.push(w.numClipIntersection),M.push(w.depthPacking)}function _(M,w){a.disableAll(),w.isWebGL2&&a.enable(0),w.supportsVertexTextures&&a.enable(1),w.instancing&&a.enable(2),w.instancingColor&&a.enable(3),w.matcap&&a.enable(4),w.envMap&&a.enable(5),w.normalMapObjectSpace&&a.enable(6),w.normalMapTangentSpace&&a.enable(7),w.clearcoat&&a.enable(8),w.iridescence&&a.enable(9),w.alphaTest&&a.enable(10),w.vertexColors&&a.enable(11),w.vertexAlphas&&a.enable(12),w.vertexUv1s&&a.enable(13),w.vertexUv2s&&a.enable(14),w.vertexUv3s&&a.enable(15),w.vertexTangents&&a.enable(16),w.anisotropy&&a.enable(17),M.push(a.mask),a.disableAll(),w.fog&&a.enable(0),w.useFog&&a.enable(1),w.flatShading&&a.enable(2),w.logarithmicDepthBuffer&&a.enable(3),w.skinning&&a.enable(4),w.morphTargets&&a.enable(5),w.morphNormals&&a.enable(6),w.morphColors&&a.enable(7),w.premultipliedAlpha&&a.enable(8),w.shadowMapEnabled&&a.enable(9),w.useLegacyLights&&a.enable(10),w.doubleSided&&a.enable(11),w.flipSided&&a.enable(12),w.useDepthPacking&&a.enable(13),w.dithering&&a.enable(14),w.transmission&&a.enable(15),w.sheen&&a.enable(16),w.opaque&&a.enable(17),w.pointsUvs&&a.enable(18),M.push(a.mask)}function T(M){const w=g[M.type];let q;if(w){const ie=It[w];q=il.clone(ie.uniforms)}else q=M.uniforms;return q}function A(M,w){let q;for(let ie=0,F=c.length;ie<F;ie++){const G=c[ie];if(G.cacheKey===w){q=G,++q.usedTimes;break}}return q===void 0&&(q=new fd(i,w,M,s),c.push(q)),q}function R(M){if(--M.usedTimes===0){const w=c.indexOf(M);c[w]=c[c.length-1],c.pop(),M.destroy()}}function P(M){l.remove(M)}function D(){l.dispose()}return{getParameters:p,getProgramCacheKey:d,getUniforms:T,acquireProgram:A,releaseProgram:R,releaseShaderCache:P,programs:c,dispose:D}}function _d(){let i=new WeakMap;function e(s){let o=i.get(s);return o===void 0&&(o={},i.set(s,o)),o}function t(s){i.delete(s)}function n(s,o,a){i.get(s)[o]=a}function r(){i=new WeakMap}return{get:e,remove:t,update:n,dispose:r}}function vd(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.material.id!==e.material.id?i.material.id-e.material.id:i.z!==e.z?i.z-e.z:i.id-e.id}function Da(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.z!==e.z?e.z-i.z:i.id-e.id}function Ia(){const i=[];let e=0;const t=[],n=[],r=[];function s(){e=0,t.length=0,n.length=0,r.length=0}function o(h,f,m,g,v,p){let d=i[e];return d===void 0?(d={id:h.id,object:h,geometry:f,material:m,groupOrder:g,renderOrder:h.renderOrder,z:v,group:p},i[e]=d):(d.id=h.id,d.object=h,d.geometry=f,d.material=m,d.groupOrder=g,d.renderOrder=h.renderOrder,d.z=v,d.group=p),e++,d}function a(h,f,m,g,v,p){const d=o(h,f,m,g,v,p);m.transmission>0?n.push(d):m.transparent===!0?r.push(d):t.push(d)}function l(h,f,m,g,v,p){const d=o(h,f,m,g,v,p);m.transmission>0?n.unshift(d):m.transparent===!0?r.unshift(d):t.unshift(d)}function c(h,f){t.length>1&&t.sort(h||vd),n.length>1&&n.sort(f||Da),r.length>1&&r.sort(f||Da)}function u(){for(let h=e,f=i.length;h<f;h++){const m=i[h];if(m.id===null)break;m.id=null,m.object=null,m.geometry=null,m.material=null,m.group=null}}return{opaque:t,transmissive:n,transparent:r,init:s,push:a,unshift:l,finish:u,sort:c}}function xd(){let i=new WeakMap;function e(n,r){const s=i.get(n);let o;return s===void 0?(o=new Ia,i.set(n,[o])):r>=s.length?(o=new Ia,s.push(o)):o=s[r],o}function t(){i=new WeakMap}return{get:e,dispose:t}}function Md(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new L,color:new Ve};break;case"SpotLight":t={position:new L,direction:new L,color:new Ve,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new L,color:new Ve,distance:0,decay:0};break;case"HemisphereLight":t={direction:new L,skyColor:new Ve,groundColor:new Ve};break;case"RectAreaLight":t={color:new Ve,position:new L,halfWidth:new L,halfHeight:new L};break}return i[e.id]=t,t}}}function Sd(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new pe};break;case"SpotLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new pe};break;case"PointLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new pe,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[e.id]=t,t}}}let Ed=0;function yd(i,e){return(e.castShadow?2:0)-(i.castShadow?2:0)+(e.map?1:0)-(i.map?1:0)}function Td(i,e){const t=new Md,n=Sd(),r={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0};for(let u=0;u<9;u++)r.probe.push(new L);const s=new L,o=new st,a=new st;function l(u,h){let f=0,m=0,g=0;for(let q=0;q<9;q++)r.probe[q].set(0,0,0);let v=0,p=0,d=0,y=0,_=0,T=0,A=0,R=0,P=0,D=0;u.sort(yd);const M=h===!0?Math.PI:1;for(let q=0,ie=u.length;q<ie;q++){const F=u[q],G=F.color,H=F.intensity,ee=F.distance,X=F.shadow&&F.shadow.map?F.shadow.map.texture:null;if(F.isAmbientLight)f+=G.r*H*M,m+=G.g*H*M,g+=G.b*H*M;else if(F.isLightProbe)for(let Y=0;Y<9;Y++)r.probe[Y].addScaledVector(F.sh.coefficients[Y],H);else if(F.isDirectionalLight){const Y=t.get(F);if(Y.color.copy(F.color).multiplyScalar(F.intensity*M),F.castShadow){const K=F.shadow,j=n.get(F);j.shadowBias=K.bias,j.shadowNormalBias=K.normalBias,j.shadowRadius=K.radius,j.shadowMapSize=K.mapSize,r.directionalShadow[v]=j,r.directionalShadowMap[v]=X,r.directionalShadowMatrix[v]=F.shadow.matrix,T++}r.directional[v]=Y,v++}else if(F.isSpotLight){const Y=t.get(F);Y.position.setFromMatrixPosition(F.matrixWorld),Y.color.copy(G).multiplyScalar(H*M),Y.distance=ee,Y.coneCos=Math.cos(F.angle),Y.penumbraCos=Math.cos(F.angle*(1-F.penumbra)),Y.decay=F.decay,r.spot[d]=Y;const K=F.shadow;if(F.map&&(r.spotLightMap[P]=F.map,P++,K.updateMatrices(F),F.castShadow&&D++),r.spotLightMatrix[d]=K.matrix,F.castShadow){const j=n.get(F);j.shadowBias=K.bias,j.shadowNormalBias=K.normalBias,j.shadowRadius=K.radius,j.shadowMapSize=K.mapSize,r.spotShadow[d]=j,r.spotShadowMap[d]=X,R++}d++}else if(F.isRectAreaLight){const Y=t.get(F);Y.color.copy(G).multiplyScalar(H),Y.halfWidth.set(F.width*.5,0,0),Y.halfHeight.set(0,F.height*.5,0),r.rectArea[y]=Y,y++}else if(F.isPointLight){const Y=t.get(F);if(Y.color.copy(F.color).multiplyScalar(F.intensity*M),Y.distance=F.distance,Y.decay=F.decay,F.castShadow){const K=F.shadow,j=n.get(F);j.shadowBias=K.bias,j.shadowNormalBias=K.normalBias,j.shadowRadius=K.radius,j.shadowMapSize=K.mapSize,j.shadowCameraNear=K.camera.near,j.shadowCameraFar=K.camera.far,r.pointShadow[p]=j,r.pointShadowMap[p]=X,r.pointShadowMatrix[p]=F.shadow.matrix,A++}r.point[p]=Y,p++}else if(F.isHemisphereLight){const Y=t.get(F);Y.skyColor.copy(F.color).multiplyScalar(H*M),Y.groundColor.copy(F.groundColor).multiplyScalar(H*M),r.hemi[_]=Y,_++}}y>0&&(e.isWebGL2||i.has("OES_texture_float_linear")===!0?(r.rectAreaLTC1=se.LTC_FLOAT_1,r.rectAreaLTC2=se.LTC_FLOAT_2):i.has("OES_texture_half_float_linear")===!0?(r.rectAreaLTC1=se.LTC_HALF_1,r.rectAreaLTC2=se.LTC_HALF_2):console.error("THREE.WebGLRenderer: Unable to use RectAreaLight. Missing WebGL extensions.")),r.ambient[0]=f,r.ambient[1]=m,r.ambient[2]=g;const w=r.hash;(w.directionalLength!==v||w.pointLength!==p||w.spotLength!==d||w.rectAreaLength!==y||w.hemiLength!==_||w.numDirectionalShadows!==T||w.numPointShadows!==A||w.numSpotShadows!==R||w.numSpotMaps!==P)&&(r.directional.length=v,r.spot.length=d,r.rectArea.length=y,r.point.length=p,r.hemi.length=_,r.directionalShadow.length=T,r.directionalShadowMap.length=T,r.pointShadow.length=A,r.pointShadowMap.length=A,r.spotShadow.length=R,r.spotShadowMap.length=R,r.directionalShadowMatrix.length=T,r.pointShadowMatrix.length=A,r.spotLightMatrix.length=R+P-D,r.spotLightMap.length=P,r.numSpotLightShadowsWithMaps=D,w.directionalLength=v,w.pointLength=p,w.spotLength=d,w.rectAreaLength=y,w.hemiLength=_,w.numDirectionalShadows=T,w.numPointShadows=A,w.numSpotShadows=R,w.numSpotMaps=P,r.version=Ed++)}function c(u,h){let f=0,m=0,g=0,v=0,p=0;const d=h.matrixWorldInverse;for(let y=0,_=u.length;y<_;y++){const T=u[y];if(T.isDirectionalLight){const A=r.directional[f];A.direction.setFromMatrixPosition(T.matrixWorld),s.setFromMatrixPosition(T.target.matrixWorld),A.direction.sub(s),A.direction.transformDirection(d),f++}else if(T.isSpotLight){const A=r.spot[g];A.position.setFromMatrixPosition(T.matrixWorld),A.position.applyMatrix4(d),A.direction.setFromMatrixPosition(T.matrixWorld),s.setFromMatrixPosition(T.target.matrixWorld),A.direction.sub(s),A.direction.transformDirection(d),g++}else if(T.isRectAreaLight){const A=r.rectArea[v];A.position.setFromMatrixPosition(T.matrixWorld),A.position.applyMatrix4(d),a.identity(),o.copy(T.matrixWorld),o.premultiply(d),a.extractRotation(o),A.halfWidth.set(T.width*.5,0,0),A.halfHeight.set(0,T.height*.5,0),A.halfWidth.applyMatrix4(a),A.halfHeight.applyMatrix4(a),v++}else if(T.isPointLight){const A=r.point[m];A.position.setFromMatrixPosition(T.matrixWorld),A.position.applyMatrix4(d),m++}else if(T.isHemisphereLight){const A=r.hemi[p];A.direction.setFromMatrixPosition(T.matrixWorld),A.direction.transformDirection(d),p++}}}return{setup:l,setupView:c,state:r}}function Na(i,e){const t=new Td(i,e),n=[],r=[];function s(){n.length=0,r.length=0}function o(h){n.push(h)}function a(h){r.push(h)}function l(h){t.setup(n,h)}function c(h){t.setupView(n,h)}return{init:s,state:{lightsArray:n,shadowsArray:r,lights:t},setupLights:l,setupLightsView:c,pushLight:o,pushShadow:a}}function Ad(i,e){let t=new WeakMap;function n(s,o=0){const a=t.get(s);let l;return a===void 0?(l=new Na(i,e),t.set(s,[l])):o>=a.length?(l=new Na(i,e),a.push(l)):l=a[o],l}function r(){t=new WeakMap}return{get:n,dispose:r}}class bd extends Si{constructor(e){super(),this.isMeshDepthMaterial=!0,this.type="MeshDepthMaterial",this.depthPacking=yc,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(e)}copy(e){return super.copy(e),this.depthPacking=e.depthPacking,this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this}}class wd extends Si{constructor(e){super(),this.isMeshDistanceMaterial=!0,this.type="MeshDistanceMaterial",this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(e)}copy(e){return super.copy(e),this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this}}const Rd=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function Pd(i,e,t){let n=new vo;const r=new pe,s=new pe,o=new ot,a=new bd({depthPacking:Tc}),l=new wd,c={},u=t.maxTextureSize,h={[on]:pt,[pt]:on,[Zt]:Zt},f=new bn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new pe},radius:{value:4}},vertexShader:Rd,fragmentShader:Cd}),m=f.clone();m.defines.HORIZONTAL_PASS=1;const g=new ln;g.setAttribute("position",new Ft(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new jt(g,f),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Xa;let d=this.type;this.render=function(A,R,P){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||A.length===0)return;const D=i.getRenderTarget(),M=i.getActiveCubeFace(),w=i.getActiveMipmapLevel(),q=i.state;q.setBlending(sn),q.buffers.color.setClear(1,1,1,1),q.buffers.depth.setTest(!0),q.setScissorTest(!1);const ie=d!==Yt&&this.type===Yt,F=d===Yt&&this.type!==Yt;for(let G=0,H=A.length;G<H;G++){const ee=A[G],X=ee.shadow;if(X===void 0){console.warn("THREE.WebGLShadowMap:",ee,"has no shadow.");continue}if(X.autoUpdate===!1&&X.needsUpdate===!1)continue;r.copy(X.mapSize);const Y=X.getFrameExtents();if(r.multiply(Y),s.copy(X.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/Y.x),r.x=s.x*Y.x,X.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/Y.y),r.y=s.y*Y.y,X.mapSize.y=s.y)),X.map===null||ie===!0||F===!0){const j=this.type!==Yt?{minFilter:dt,magFilter:dt}:{};X.map!==null&&X.map.dispose(),X.map=new Tn(r.x,r.y,j),X.map.texture.name=ee.name+".shadowMap",X.camera.updateProjectionMatrix()}i.setRenderTarget(X.map),i.clear();const K=X.getViewportCount();for(let j=0;j<K;j++){const fe=X.getViewport(j);o.set(s.x*fe.x,s.y*fe.y,s.x*fe.z,s.y*fe.w),q.viewport(o),X.updateMatrices(ee,j),n=X.getFrustum(),T(R,P,X.camera,ee,this.type)}X.isPointLightShadow!==!0&&this.type===Yt&&y(X,P),X.needsUpdate=!1}d=this.type,p.needsUpdate=!1,i.setRenderTarget(D,M,w)};function y(A,R){const P=e.update(v);f.defines.VSM_SAMPLES!==A.blurSamples&&(f.defines.VSM_SAMPLES=A.blurSamples,m.defines.VSM_SAMPLES=A.blurSamples,f.needsUpdate=!0,m.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new Tn(r.x,r.y)),f.uniforms.shadow_pass.value=A.map.texture,f.uniforms.resolution.value=A.mapSize,f.uniforms.radius.value=A.radius,i.setRenderTarget(A.mapPass),i.clear(),i.renderBufferDirect(R,null,P,f,v,null),m.uniforms.shadow_pass.value=A.mapPass.texture,m.uniforms.resolution.value=A.mapSize,m.uniforms.radius.value=A.radius,i.setRenderTarget(A.map),i.clear(),i.renderBufferDirect(R,null,P,m,v,null)}function _(A,R,P,D){let M=null;const w=P.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(w!==void 0)M=w;else if(M=P.isPointLight===!0?l:a,i.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0){const q=M.uuid,ie=R.uuid;let F=c[q];F===void 0&&(F={},c[q]=F);let G=F[ie];G===void 0&&(G=M.clone(),F[ie]=G),M=G}if(M.visible=R.visible,M.wireframe=R.wireframe,D===Yt?M.side=R.shadowSide!==null?R.shadowSide:R.side:M.side=R.shadowSide!==null?R.shadowSide:h[R.side],M.alphaMap=R.alphaMap,M.alphaTest=R.alphaTest,M.map=R.map,M.clipShadows=R.clipShadows,M.clippingPlanes=R.clippingPlanes,M.clipIntersection=R.clipIntersection,M.displacementMap=R.displacementMap,M.displacementScale=R.displacementScale,M.displacementBias=R.displacementBias,M.wireframeLinewidth=R.wireframeLinewidth,M.linewidth=R.linewidth,P.isPointLight===!0&&M.isMeshDistanceMaterial===!0){const q=i.properties.get(M);q.light=P}return M}function T(A,R,P,D,M){if(A.visible===!1)return;if(A.layers.test(R.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&M===Yt)&&(!A.frustumCulled||n.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(P.matrixWorldInverse,A.matrixWorld);const ie=e.update(A),F=A.material;if(Array.isArray(F)){const G=ie.groups;for(let H=0,ee=G.length;H<ee;H++){const X=G[H],Y=F[X.materialIndex];if(Y&&Y.visible){const K=_(A,Y,D,M);i.renderBufferDirect(P,null,ie,K,A,X)}}}else if(F.visible){const G=_(A,F,D,M);i.renderBufferDirect(P,null,ie,G,A,null)}}const q=A.children;for(let ie=0,F=q.length;ie<F;ie++)T(q[ie],R,P,D,M)}}function Ld(i,e,t){const n=t.isWebGL2;function r(){let C=!1;const ae=new ot;let O=null;const re=new ot(0,0,0,0);return{setMask:function(oe){O!==oe&&!C&&(i.colorMask(oe,oe,oe,oe),O=oe)},setLocked:function(oe){C=oe},setClear:function(oe,ze,Xe,Ke,un){un===!0&&(oe*=Ke,ze*=Ke,Xe*=Ke),ae.set(oe,ze,Xe,Ke),re.equals(ae)===!1&&(i.clearColor(oe,ze,Xe,Ke),re.copy(ae))},reset:function(){C=!1,O=null,re.set(-1,0,0,0)}}}function s(){let C=!1,ae=null,O=null,re=null;return{setTest:function(oe){oe?ve(i.DEPTH_TEST):Le(i.DEPTH_TEST)},setMask:function(oe){ae!==oe&&!C&&(i.depthMask(oe),ae=oe)},setFunc:function(oe){if(O!==oe){switch(oe){case Qo:i.depthFunc(i.NEVER);break;case ec:i.depthFunc(i.ALWAYS);break;case tc:i.depthFunc(i.LESS);break;case Wr:i.depthFunc(i.LEQUAL);break;case nc:i.depthFunc(i.EQUAL);break;case ic:i.depthFunc(i.GEQUAL);break;case rc:i.depthFunc(i.GREATER);break;case sc:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}O=oe}},setLocked:function(oe){C=oe},setClear:function(oe){re!==oe&&(i.clearDepth(oe),re=oe)},reset:function(){C=!1,ae=null,O=null,re=null}}}function o(){let C=!1,ae=null,O=null,re=null,oe=null,ze=null,Xe=null,Ke=null,un=null;return{setTest:function(qe){C||(qe?ve(i.STENCIL_TEST):Le(i.STENCIL_TEST))},setMask:function(qe){ae!==qe&&!C&&(i.stencilMask(qe),ae=qe)},setFunc:function(qe,Dt,ut){(O!==qe||re!==Dt||oe!==ut)&&(i.stencilFunc(qe,Dt,ut),O=qe,re=Dt,oe=ut)},setOp:function(qe,Dt,ut){(ze!==qe||Xe!==Dt||Ke!==ut)&&(i.stencilOp(qe,Dt,ut),ze=qe,Xe=Dt,Ke=ut)},setLocked:function(qe){C=qe},setClear:function(qe){un!==qe&&(i.clearStencil(qe),un=qe)},reset:function(){C=!1,ae=null,O=null,re=null,oe=null,ze=null,Xe=null,Ke=null,un=null}}}const a=new r,l=new s,c=new o,u=new WeakMap,h=new WeakMap;let f={},m={},g=new WeakMap,v=[],p=null,d=!1,y=null,_=null,T=null,A=null,R=null,P=null,D=null,M=!1,w=null,q=null,ie=null,F=null,G=null;const H=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let ee=!1,X=0;const Y=i.getParameter(i.VERSION);Y.indexOf("WebGL")!==-1?(X=parseFloat(/^WebGL (\d)/.exec(Y)[1]),ee=X>=1):Y.indexOf("OpenGL ES")!==-1&&(X=parseFloat(/^OpenGL ES (\d)/.exec(Y)[1]),ee=X>=2);let K=null,j={};const fe=i.getParameter(i.SCISSOR_BOX),z=i.getParameter(i.VIEWPORT),J=new ot().fromArray(fe),$=new ot().fromArray(z);function ce(C,ae,O,re){const oe=new Uint8Array(4),ze=i.createTexture();i.bindTexture(C,ze),i.texParameteri(C,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(C,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Xe=0;Xe<O;Xe++)n&&(C===i.TEXTURE_3D||C===i.TEXTURE_2D_ARRAY)?i.texImage3D(ae,0,i.RGBA,1,1,re,0,i.RGBA,i.UNSIGNED_BYTE,oe):i.texImage2D(ae+Xe,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,oe);return ze}const le={};le[i.TEXTURE_2D]=ce(i.TEXTURE_2D,i.TEXTURE_2D,1),le[i.TEXTURE_CUBE_MAP]=ce(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),n&&(le[i.TEXTURE_2D_ARRAY]=ce(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),le[i.TEXTURE_3D]=ce(i.TEXTURE_3D,i.TEXTURE_3D,1,1)),a.setClear(0,0,0,1),l.setClear(1),c.setClear(0),ve(i.DEPTH_TEST),l.setFunc(Wr),Me(!1),He(Ms),ve(i.CULL_FACE),xe(sn);function ve(C){f[C]!==!0&&(i.enable(C),f[C]=!0)}function Le(C){f[C]!==!1&&(i.disable(C),f[C]=!1)}function Ee(C,ae){return m[C]!==ae?(i.bindFramebuffer(C,ae),m[C]=ae,n&&(C===i.DRAW_FRAMEBUFFER&&(m[i.FRAMEBUFFER]=ae),C===i.FRAMEBUFFER&&(m[i.DRAW_FRAMEBUFFER]=ae)),!0):!1}function Ye(C,ae){let O=v,re=!1;if(C)if(O=g.get(ae),O===void 0&&(O=[],g.set(ae,O)),C.isWebGLMultipleRenderTargets){const oe=C.texture;if(O.length!==oe.length||O[0]!==i.COLOR_ATTACHMENT0){for(let ze=0,Xe=oe.length;ze<Xe;ze++)O[ze]=i.COLOR_ATTACHMENT0+ze;O.length=oe.length,re=!0}}else O[0]!==i.COLOR_ATTACHMENT0&&(O[0]=i.COLOR_ATTACHMENT0,re=!0);else O[0]!==i.BACK&&(O[0]=i.BACK,re=!0);re&&(t.isWebGL2?i.drawBuffers(O):e.get("WEBGL_draw_buffers").drawBuffersWEBGL(O))}function Ne(C){return p!==C?(i.useProgram(C),p=C,!0):!1}const I={[Yn]:i.FUNC_ADD,[Vo]:i.FUNC_SUBTRACT,[ko]:i.FUNC_REVERSE_SUBTRACT};if(n)I[Ts]=i.MIN,I[As]=i.MAX;else{const C=e.get("EXT_blend_minmax");C!==null&&(I[Ts]=C.MIN_EXT,I[As]=C.MAX_EXT)}const $e={[Wo]:i.ZERO,[Xo]:i.ONE,[qo]:i.SRC_COLOR,[qa]:i.SRC_ALPHA,[$o]:i.SRC_ALPHA_SATURATE,[jo]:i.DST_COLOR,[Zo]:i.DST_ALPHA,[Yo]:i.ONE_MINUS_SRC_COLOR,[Ya]:i.ONE_MINUS_SRC_ALPHA,[Jo]:i.ONE_MINUS_DST_COLOR,[Ko]:i.ONE_MINUS_DST_ALPHA};function xe(C,ae,O,re,oe,ze,Xe,Ke){if(C===sn){d===!0&&(Le(i.BLEND),d=!1);return}if(d===!1&&(ve(i.BLEND),d=!0),C!==Ho){if(C!==y||Ke!==M){if((_!==Yn||R!==Yn)&&(i.blendEquation(i.FUNC_ADD),_=Yn,R=Yn),Ke)switch(C){case jn:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ss:i.blendFunc(i.ONE,i.ONE);break;case Es:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case ys:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",C);break}else switch(C){case jn:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ss:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case Es:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case ys:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",C);break}T=null,A=null,P=null,D=null,y=C,M=Ke}return}oe=oe||ae,ze=ze||O,Xe=Xe||re,(ae!==_||oe!==R)&&(i.blendEquationSeparate(I[ae],I[oe]),_=ae,R=oe),(O!==T||re!==A||ze!==P||Xe!==D)&&(i.blendFuncSeparate($e[O],$e[re],$e[ze],$e[Xe]),T=O,A=re,P=ze,D=Xe),y=C,M=!1}function Re(C,ae){C.side===Zt?Le(i.CULL_FACE):ve(i.CULL_FACE);let O=C.side===pt;ae&&(O=!O),Me(O),C.blending===jn&&C.transparent===!1?xe(sn):xe(C.blending,C.blendEquation,C.blendSrc,C.blendDst,C.blendEquationAlpha,C.blendSrcAlpha,C.blendDstAlpha,C.premultipliedAlpha),l.setFunc(C.depthFunc),l.setTest(C.depthTest),l.setMask(C.depthWrite),a.setMask(C.colorWrite);const re=C.stencilWrite;c.setTest(re),re&&(c.setMask(C.stencilWriteMask),c.setFunc(C.stencilFunc,C.stencilRef,C.stencilFuncMask),c.setOp(C.stencilFail,C.stencilZFail,C.stencilZPass)),be(C.polygonOffset,C.polygonOffsetFactor,C.polygonOffsetUnits),C.alphaToCoverage===!0?ve(i.SAMPLE_ALPHA_TO_COVERAGE):Le(i.SAMPLE_ALPHA_TO_COVERAGE)}function Me(C){w!==C&&(C?i.frontFace(i.CW):i.frontFace(i.CCW),w=C)}function He(C){C!==Bo?(ve(i.CULL_FACE),C!==q&&(C===Ms?i.cullFace(i.BACK):C===zo?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Le(i.CULL_FACE),q=C}function De(C){C!==ie&&(ee&&i.lineWidth(C),ie=C)}function be(C,ae,O){C?(ve(i.POLYGON_OFFSET_FILL),(F!==ae||G!==O)&&(i.polygonOffset(ae,O),F=ae,G=O)):Le(i.POLYGON_OFFSET_FILL)}function Ge(C){C?ve(i.SCISSOR_TEST):Le(i.SCISSOR_TEST)}function Qe(C){C===void 0&&(C=i.TEXTURE0+H-1),K!==C&&(i.activeTexture(C),K=C)}function nt(C,ae,O){O===void 0&&(K===null?O=i.TEXTURE0+H-1:O=K);let re=j[O];re===void 0&&(re={type:void 0,texture:void 0},j[O]=re),(re.type!==C||re.texture!==ae)&&(K!==O&&(i.activeTexture(O),K=O),i.bindTexture(C,ae||le[C]),re.type=C,re.texture=ae)}function E(){const C=j[K];C!==void 0&&C.type!==void 0&&(i.bindTexture(C.type,null),C.type=void 0,C.texture=void 0)}function x(){try{i.compressedTexImage2D.apply(i,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function V(){try{i.compressedTexImage3D.apply(i,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function ne(){try{i.texSubImage2D.apply(i,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function te(){try{i.texSubImage3D.apply(i,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function b(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function Z(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function Q(){try{i.texStorage2D.apply(i,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function B(){try{i.texStorage3D.apply(i,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function de(){try{i.texImage2D.apply(i,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function _e(){try{i.texImage3D.apply(i,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function ge(C){J.equals(C)===!1&&(i.scissor(C.x,C.y,C.z,C.w),J.copy(C))}function me(C){$.equals(C)===!1&&(i.viewport(C.x,C.y,C.z,C.w),$.copy(C))}function ue(C,ae){let O=h.get(ae);O===void 0&&(O=new WeakMap,h.set(ae,O));let re=O.get(C);re===void 0&&(re=i.getUniformBlockIndex(ae,C.name),O.set(C,re))}function ye(C,ae){const re=h.get(ae).get(C);u.get(ae)!==re&&(i.uniformBlockBinding(ae,re,C.__bindingPointIndex),u.set(ae,re))}function Oe(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),n===!0&&(i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null)),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),f={},K=null,j={},m={},g=new WeakMap,v=[],p=null,d=!1,y=null,_=null,T=null,A=null,R=null,P=null,D=null,M=!1,w=null,q=null,ie=null,F=null,G=null,J.set(0,0,i.canvas.width,i.canvas.height),$.set(0,0,i.canvas.width,i.canvas.height),a.reset(),l.reset(),c.reset()}return{buffers:{color:a,depth:l,stencil:c},enable:ve,disable:Le,bindFramebuffer:Ee,drawBuffers:Ye,useProgram:Ne,setBlending:xe,setMaterial:Re,setFlipSided:Me,setCullFace:He,setLineWidth:De,setPolygonOffset:be,setScissorTest:Ge,activeTexture:Qe,bindTexture:nt,unbindTexture:E,compressedTexImage2D:x,compressedTexImage3D:V,texImage2D:de,texImage3D:_e,updateUBOMapping:ue,uniformBlockBinding:ye,texStorage2D:Q,texStorage3D:B,texSubImage2D:ne,texSubImage3D:te,compressedTexSubImage2D:b,compressedTexSubImage3D:Z,scissor:ge,viewport:me,reset:Oe}}function Ud(i,e,t,n,r,s,o){const a=r.isWebGL2,l=r.maxTextures,c=r.maxCubemapSize,u=r.maxTextureSize,h=r.maxSamples,f=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,m=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),g=new WeakMap;let v;const p=new WeakMap;let d=!1;try{d=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function y(E,x){return d?new OffscreenCanvas(E,x):gi("canvas")}function _(E,x,V,ne){let te=1;if((E.width>ne||E.height>ne)&&(te=ne/Math.max(E.width,E.height)),te<1||x===!0)if(typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&E instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&E instanceof ImageBitmap){const b=x?Jr:Math.floor,Z=b(te*E.width),Q=b(te*E.height);v===void 0&&(v=y(Z,Q));const B=V?y(Z,Q):v;return B.width=Z,B.height=Q,B.getContext("2d").drawImage(E,0,0,Z,Q),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+E.width+"x"+E.height+") to ("+Z+"x"+Q+")."),B}else return"data"in E&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+E.width+"x"+E.height+")."),E;return E}function T(E){return $s(E.width)&&$s(E.height)}function A(E){return a?!1:E.wrapS!==Pt||E.wrapT!==Pt||E.minFilter!==dt&&E.minFilter!==yt}function R(E,x){return E.generateMipmaps&&x&&E.minFilter!==dt&&E.minFilter!==yt}function P(E){i.generateMipmap(E)}function D(E,x,V,ne,te=!1){if(a===!1)return x;if(E!==null){if(i[E]!==void 0)return i[E];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+E+"'")}let b=x;return x===i.RED&&(V===i.FLOAT&&(b=i.R32F),V===i.HALF_FLOAT&&(b=i.R16F),V===i.UNSIGNED_BYTE&&(b=i.R8)),x===i.RG&&(V===i.FLOAT&&(b=i.RG32F),V===i.HALF_FLOAT&&(b=i.RG16F),V===i.UNSIGNED_BYTE&&(b=i.RG8)),x===i.RGBA&&(V===i.FLOAT&&(b=i.RGBA32F),V===i.HALF_FLOAT&&(b=i.RGBA16F),V===i.UNSIGNED_BYTE&&(b=ne===Pe&&te===!1?i.SRGB8_ALPHA8:i.RGBA8),V===i.UNSIGNED_SHORT_4_4_4_4&&(b=i.RGBA4),V===i.UNSIGNED_SHORT_5_5_5_1&&(b=i.RGB5_A1)),(b===i.R16F||b===i.R32F||b===i.RG16F||b===i.RG32F||b===i.RGBA16F||b===i.RGBA32F)&&e.get("EXT_color_buffer_float"),b}function M(E,x,V){return R(E,V)===!0||E.isFramebufferTexture&&E.minFilter!==dt&&E.minFilter!==yt?Math.log2(Math.max(x.width,x.height))+1:E.mipmaps!==void 0&&E.mipmaps.length>0?E.mipmaps.length:E.isCompressedTexture&&Array.isArray(E.image)?x.mipmaps.length:1}function w(E){return E===dt||E===bs||E===cr?i.NEAREST:i.LINEAR}function q(E){const x=E.target;x.removeEventListener("dispose",q),F(x),x.isVideoTexture&&g.delete(x)}function ie(E){const x=E.target;x.removeEventListener("dispose",ie),H(x)}function F(E){const x=n.get(E);if(x.__webglInit===void 0)return;const V=E.source,ne=p.get(V);if(ne){const te=ne[x.__cacheKey];te.usedTimes--,te.usedTimes===0&&G(E),Object.keys(ne).length===0&&p.delete(V)}n.remove(E)}function G(E){const x=n.get(E);i.deleteTexture(x.__webglTexture);const V=E.source,ne=p.get(V);delete ne[x.__cacheKey],o.memory.textures--}function H(E){const x=E.texture,V=n.get(E),ne=n.get(x);if(ne.__webglTexture!==void 0&&(i.deleteTexture(ne.__webglTexture),o.memory.textures--),E.depthTexture&&E.depthTexture.dispose(),E.isWebGLCubeRenderTarget)for(let te=0;te<6;te++)i.deleteFramebuffer(V.__webglFramebuffer[te]),V.__webglDepthbuffer&&i.deleteRenderbuffer(V.__webglDepthbuffer[te]);else{if(i.deleteFramebuffer(V.__webglFramebuffer),V.__webglDepthbuffer&&i.deleteRenderbuffer(V.__webglDepthbuffer),V.__webglMultisampledFramebuffer&&i.deleteFramebuffer(V.__webglMultisampledFramebuffer),V.__webglColorRenderbuffer)for(let te=0;te<V.__webglColorRenderbuffer.length;te++)V.__webglColorRenderbuffer[te]&&i.deleteRenderbuffer(V.__webglColorRenderbuffer[te]);V.__webglDepthRenderbuffer&&i.deleteRenderbuffer(V.__webglDepthRenderbuffer)}if(E.isWebGLMultipleRenderTargets)for(let te=0,b=x.length;te<b;te++){const Z=n.get(x[te]);Z.__webglTexture&&(i.deleteTexture(Z.__webglTexture),o.memory.textures--),n.remove(x[te])}n.remove(x),n.remove(E)}let ee=0;function X(){ee=0}function Y(){const E=ee;return E>=l&&console.warn("THREE.WebGLTextures: Trying to use "+E+" texture units while this GPU supports only "+l),ee+=1,E}function K(E){const x=[];return x.push(E.wrapS),x.push(E.wrapT),x.push(E.wrapR||0),x.push(E.magFilter),x.push(E.minFilter),x.push(E.anisotropy),x.push(E.internalFormat),x.push(E.format),x.push(E.type),x.push(E.generateMipmaps),x.push(E.premultiplyAlpha),x.push(E.flipY),x.push(E.unpackAlignment),x.push(E.colorSpace),x.join()}function j(E,x){const V=n.get(E);if(E.isVideoTexture&&Qe(E),E.isRenderTargetTexture===!1&&E.version>0&&V.__version!==E.version){const ne=E.image;if(ne===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(ne.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Ee(V,E,x);return}}t.bindTexture(i.TEXTURE_2D,V.__webglTexture,i.TEXTURE0+x)}function fe(E,x){const V=n.get(E);if(E.version>0&&V.__version!==E.version){Ee(V,E,x);return}t.bindTexture(i.TEXTURE_2D_ARRAY,V.__webglTexture,i.TEXTURE0+x)}function z(E,x){const V=n.get(E);if(E.version>0&&V.__version!==E.version){Ee(V,E,x);return}t.bindTexture(i.TEXTURE_3D,V.__webglTexture,i.TEXTURE0+x)}function J(E,x){const V=n.get(E);if(E.version>0&&V.__version!==E.version){Ye(V,E,x);return}t.bindTexture(i.TEXTURE_CUBE_MAP,V.__webglTexture,i.TEXTURE0+x)}const $={[Yr]:i.REPEAT,[Pt]:i.CLAMP_TO_EDGE,[Zr]:i.MIRRORED_REPEAT},ce={[dt]:i.NEAREST,[bs]:i.NEAREST_MIPMAP_NEAREST,[cr]:i.NEAREST_MIPMAP_LINEAR,[yt]:i.LINEAR,[dc]:i.LINEAR_MIPMAP_NEAREST,[pi]:i.LINEAR_MIPMAP_LINEAR},le={[wc]:i.NEVER,[Ic]:i.ALWAYS,[Rc]:i.LESS,[Pc]:i.LEQUAL,[Cc]:i.EQUAL,[Dc]:i.GEQUAL,[Lc]:i.GREATER,[Uc]:i.NOTEQUAL};function ve(E,x,V){if(V?(i.texParameteri(E,i.TEXTURE_WRAP_S,$[x.wrapS]),i.texParameteri(E,i.TEXTURE_WRAP_T,$[x.wrapT]),(E===i.TEXTURE_3D||E===i.TEXTURE_2D_ARRAY)&&i.texParameteri(E,i.TEXTURE_WRAP_R,$[x.wrapR]),i.texParameteri(E,i.TEXTURE_MAG_FILTER,ce[x.magFilter]),i.texParameteri(E,i.TEXTURE_MIN_FILTER,ce[x.minFilter])):(i.texParameteri(E,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(E,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE),(E===i.TEXTURE_3D||E===i.TEXTURE_2D_ARRAY)&&i.texParameteri(E,i.TEXTURE_WRAP_R,i.CLAMP_TO_EDGE),(x.wrapS!==Pt||x.wrapT!==Pt)&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.wrapS and Texture.wrapT should be set to THREE.ClampToEdgeWrapping."),i.texParameteri(E,i.TEXTURE_MAG_FILTER,w(x.magFilter)),i.texParameteri(E,i.TEXTURE_MIN_FILTER,w(x.minFilter)),x.minFilter!==dt&&x.minFilter!==yt&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter should be set to THREE.NearestFilter or THREE.LinearFilter.")),x.compareFunction&&(i.texParameteri(E,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(E,i.TEXTURE_COMPARE_FUNC,le[x.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){const ne=e.get("EXT_texture_filter_anisotropic");if(x.magFilter===dt||x.minFilter!==cr&&x.minFilter!==pi||x.type===rn&&e.has("OES_texture_float_linear")===!1||a===!1&&x.type===mi&&e.has("OES_texture_half_float_linear")===!1)return;(x.anisotropy>1||n.get(x).__currentAnisotropy)&&(i.texParameterf(E,ne.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(x.anisotropy,r.getMaxAnisotropy())),n.get(x).__currentAnisotropy=x.anisotropy)}}function Le(E,x){let V=!1;E.__webglInit===void 0&&(E.__webglInit=!0,x.addEventListener("dispose",q));const ne=x.source;let te=p.get(ne);te===void 0&&(te={},p.set(ne,te));const b=K(x);if(b!==E.__cacheKey){te[b]===void 0&&(te[b]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,V=!0),te[b].usedTimes++;const Z=te[E.__cacheKey];Z!==void 0&&(te[E.__cacheKey].usedTimes--,Z.usedTimes===0&&G(x)),E.__cacheKey=b,E.__webglTexture=te[b].texture}return V}function Ee(E,x,V){let ne=i.TEXTURE_2D;(x.isDataArrayTexture||x.isCompressedArrayTexture)&&(ne=i.TEXTURE_2D_ARRAY),x.isData3DTexture&&(ne=i.TEXTURE_3D);const te=Le(E,x),b=x.source;t.bindTexture(ne,E.__webglTexture,i.TEXTURE0+V);const Z=n.get(b);if(b.version!==Z.__version||te===!0){t.activeTexture(i.TEXTURE0+V),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,x.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,x.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.NONE);const Q=A(x)&&T(x.image)===!1;let B=_(x.image,Q,!1,u);B=nt(x,B);const de=T(B)||a,_e=s.convert(x.format,x.colorSpace);let ge=s.convert(x.type),me=D(x.internalFormat,_e,ge,x.colorSpace);ve(ne,x,de);let ue;const ye=x.mipmaps,Oe=a&&x.isVideoTexture!==!0,C=Z.__version===void 0||te===!0,ae=M(x,B,de);if(x.isDepthTexture)me=i.DEPTH_COMPONENT,a?x.type===rn?me=i.DEPTH_COMPONENT32F:x.type===nn?me=i.DEPTH_COMPONENT24:x.type===Mn?me=i.DEPTH24_STENCIL8:me=i.DEPTH_COMPONENT16:x.type===rn&&console.error("WebGLRenderer: Floating point depth texture requires WebGL2."),x.format===Sn&&me===i.DEPTH_COMPONENT&&x.type!==is&&x.type!==nn&&(console.warn("THREE.WebGLRenderer: Use UnsignedShortType or UnsignedIntType for DepthFormat DepthTexture."),x.type=nn,ge=s.convert(x.type)),x.format===ei&&me===i.DEPTH_COMPONENT&&(me=i.DEPTH_STENCIL,x.type!==Mn&&(console.warn("THREE.WebGLRenderer: Use UnsignedInt248Type for DepthStencilFormat DepthTexture."),x.type=Mn,ge=s.convert(x.type))),C&&(Oe?t.texStorage2D(i.TEXTURE_2D,1,me,B.width,B.height):t.texImage2D(i.TEXTURE_2D,0,me,B.width,B.height,0,_e,ge,null));else if(x.isDataTexture)if(ye.length>0&&de){Oe&&C&&t.texStorage2D(i.TEXTURE_2D,ae,me,ye[0].width,ye[0].height);for(let O=0,re=ye.length;O<re;O++)ue=ye[O],Oe?t.texSubImage2D(i.TEXTURE_2D,O,0,0,ue.width,ue.height,_e,ge,ue.data):t.texImage2D(i.TEXTURE_2D,O,me,ue.width,ue.height,0,_e,ge,ue.data);x.generateMipmaps=!1}else Oe?(C&&t.texStorage2D(i.TEXTURE_2D,ae,me,B.width,B.height),t.texSubImage2D(i.TEXTURE_2D,0,0,0,B.width,B.height,_e,ge,B.data)):t.texImage2D(i.TEXTURE_2D,0,me,B.width,B.height,0,_e,ge,B.data);else if(x.isCompressedTexture)if(x.isCompressedArrayTexture){Oe&&C&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ae,me,ye[0].width,ye[0].height,B.depth);for(let O=0,re=ye.length;O<re;O++)ue=ye[O],x.format!==Lt?_e!==null?Oe?t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,O,0,0,0,ue.width,ue.height,B.depth,_e,ue.data,0,0):t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,O,me,ue.width,ue.height,B.depth,0,ue.data,0,0):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Oe?t.texSubImage3D(i.TEXTURE_2D_ARRAY,O,0,0,0,ue.width,ue.height,B.depth,_e,ge,ue.data):t.texImage3D(i.TEXTURE_2D_ARRAY,O,me,ue.width,ue.height,B.depth,0,_e,ge,ue.data)}else{Oe&&C&&t.texStorage2D(i.TEXTURE_2D,ae,me,ye[0].width,ye[0].height);for(let O=0,re=ye.length;O<re;O++)ue=ye[O],x.format!==Lt?_e!==null?Oe?t.compressedTexSubImage2D(i.TEXTURE_2D,O,0,0,ue.width,ue.height,_e,ue.data):t.compressedTexImage2D(i.TEXTURE_2D,O,me,ue.width,ue.height,0,ue.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Oe?t.texSubImage2D(i.TEXTURE_2D,O,0,0,ue.width,ue.height,_e,ge,ue.data):t.texImage2D(i.TEXTURE_2D,O,me,ue.width,ue.height,0,_e,ge,ue.data)}else if(x.isDataArrayTexture)Oe?(C&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ae,me,B.width,B.height,B.depth),t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,B.width,B.height,B.depth,_e,ge,B.data)):t.texImage3D(i.TEXTURE_2D_ARRAY,0,me,B.width,B.height,B.depth,0,_e,ge,B.data);else if(x.isData3DTexture)Oe?(C&&t.texStorage3D(i.TEXTURE_3D,ae,me,B.width,B.height,B.depth),t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,B.width,B.height,B.depth,_e,ge,B.data)):t.texImage3D(i.TEXTURE_3D,0,me,B.width,B.height,B.depth,0,_e,ge,B.data);else if(x.isFramebufferTexture){if(C)if(Oe)t.texStorage2D(i.TEXTURE_2D,ae,me,B.width,B.height);else{let O=B.width,re=B.height;for(let oe=0;oe<ae;oe++)t.texImage2D(i.TEXTURE_2D,oe,me,O,re,0,_e,ge,null),O>>=1,re>>=1}}else if(ye.length>0&&de){Oe&&C&&t.texStorage2D(i.TEXTURE_2D,ae,me,ye[0].width,ye[0].height);for(let O=0,re=ye.length;O<re;O++)ue=ye[O],Oe?t.texSubImage2D(i.TEXTURE_2D,O,0,0,_e,ge,ue):t.texImage2D(i.TEXTURE_2D,O,me,_e,ge,ue);x.generateMipmaps=!1}else Oe?(C&&t.texStorage2D(i.TEXTURE_2D,ae,me,B.width,B.height),t.texSubImage2D(i.TEXTURE_2D,0,0,0,_e,ge,B)):t.texImage2D(i.TEXTURE_2D,0,me,_e,ge,B);R(x,de)&&P(ne),Z.__version=b.version,x.onUpdate&&x.onUpdate(x)}E.__version=x.version}function Ye(E,x,V){if(x.image.length!==6)return;const ne=Le(E,x),te=x.source;t.bindTexture(i.TEXTURE_CUBE_MAP,E.__webglTexture,i.TEXTURE0+V);const b=n.get(te);if(te.version!==b.__version||ne===!0){t.activeTexture(i.TEXTURE0+V),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,x.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,x.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.NONE);const Z=x.isCompressedTexture||x.image[0].isCompressedTexture,Q=x.image[0]&&x.image[0].isDataTexture,B=[];for(let O=0;O<6;O++)!Z&&!Q?B[O]=_(x.image[O],!1,!0,c):B[O]=Q?x.image[O].image:x.image[O],B[O]=nt(x,B[O]);const de=B[0],_e=T(de)||a,ge=s.convert(x.format,x.colorSpace),me=s.convert(x.type),ue=D(x.internalFormat,ge,me,x.colorSpace),ye=a&&x.isVideoTexture!==!0,Oe=b.__version===void 0||ne===!0;let C=M(x,de,_e);ve(i.TEXTURE_CUBE_MAP,x,_e);let ae;if(Z){ye&&Oe&&t.texStorage2D(i.TEXTURE_CUBE_MAP,C,ue,de.width,de.height);for(let O=0;O<6;O++){ae=B[O].mipmaps;for(let re=0;re<ae.length;re++){const oe=ae[re];x.format!==Lt?ge!==null?ye?t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+O,re,0,0,oe.width,oe.height,ge,oe.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+O,re,ue,oe.width,oe.height,0,oe.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):ye?t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+O,re,0,0,oe.width,oe.height,ge,me,oe.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+O,re,ue,oe.width,oe.height,0,ge,me,oe.data)}}}else{ae=x.mipmaps,ye&&Oe&&(ae.length>0&&C++,t.texStorage2D(i.TEXTURE_CUBE_MAP,C,ue,B[0].width,B[0].height));for(let O=0;O<6;O++)if(Q){ye?t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+O,0,0,0,B[O].width,B[O].height,ge,me,B[O].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+O,0,ue,B[O].width,B[O].height,0,ge,me,B[O].data);for(let re=0;re<ae.length;re++){const ze=ae[re].image[O].image;ye?t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+O,re+1,0,0,ze.width,ze.height,ge,me,ze.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+O,re+1,ue,ze.width,ze.height,0,ge,me,ze.data)}}else{ye?t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+O,0,0,0,ge,me,B[O]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+O,0,ue,ge,me,B[O]);for(let re=0;re<ae.length;re++){const oe=ae[re];ye?t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+O,re+1,0,0,ge,me,oe.image[O]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+O,re+1,ue,ge,me,oe.image[O])}}}R(x,_e)&&P(i.TEXTURE_CUBE_MAP),b.__version=te.version,x.onUpdate&&x.onUpdate(x)}E.__version=x.version}function Ne(E,x,V,ne,te){const b=s.convert(V.format,V.colorSpace),Z=s.convert(V.type),Q=D(V.internalFormat,b,Z,V.colorSpace);n.get(x).__hasExternalTextures||(te===i.TEXTURE_3D||te===i.TEXTURE_2D_ARRAY?t.texImage3D(te,0,Q,x.width,x.height,x.depth,0,b,Z,null):t.texImage2D(te,0,Q,x.width,x.height,0,b,Z,null)),t.bindFramebuffer(i.FRAMEBUFFER,E),Ge(x)?f.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,ne,te,n.get(V).__webglTexture,0,be(x)):(te===i.TEXTURE_2D||te>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&te<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,ne,te,n.get(V).__webglTexture,0),t.bindFramebuffer(i.FRAMEBUFFER,null)}function I(E,x,V){if(i.bindRenderbuffer(i.RENDERBUFFER,E),x.depthBuffer&&!x.stencilBuffer){let ne=i.DEPTH_COMPONENT16;if(V||Ge(x)){const te=x.depthTexture;te&&te.isDepthTexture&&(te.type===rn?ne=i.DEPTH_COMPONENT32F:te.type===nn&&(ne=i.DEPTH_COMPONENT24));const b=be(x);Ge(x)?f.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,b,ne,x.width,x.height):i.renderbufferStorageMultisample(i.RENDERBUFFER,b,ne,x.width,x.height)}else i.renderbufferStorage(i.RENDERBUFFER,ne,x.width,x.height);i.framebufferRenderbuffer(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.RENDERBUFFER,E)}else if(x.depthBuffer&&x.stencilBuffer){const ne=be(x);V&&Ge(x)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,ne,i.DEPTH24_STENCIL8,x.width,x.height):Ge(x)?f.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ne,i.DEPTH24_STENCIL8,x.width,x.height):i.renderbufferStorage(i.RENDERBUFFER,i.DEPTH_STENCIL,x.width,x.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.RENDERBUFFER,E)}else{const ne=x.isWebGLMultipleRenderTargets===!0?x.texture:[x.texture];for(let te=0;te<ne.length;te++){const b=ne[te],Z=s.convert(b.format,b.colorSpace),Q=s.convert(b.type),B=D(b.internalFormat,Z,Q,b.colorSpace),de=be(x);V&&Ge(x)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,de,B,x.width,x.height):Ge(x)?f.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,de,B,x.width,x.height):i.renderbufferStorage(i.RENDERBUFFER,B,x.width,x.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function $e(E,x){if(x&&x.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,E),!(x.depthTexture&&x.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(x.depthTexture).__webglTexture||x.depthTexture.image.width!==x.width||x.depthTexture.image.height!==x.height)&&(x.depthTexture.image.width=x.width,x.depthTexture.image.height=x.height,x.depthTexture.needsUpdate=!0),j(x.depthTexture,0);const ne=n.get(x.depthTexture).__webglTexture,te=be(x);if(x.depthTexture.format===Sn)Ge(x)?f.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,ne,0,te):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,ne,0);else if(x.depthTexture.format===ei)Ge(x)?f.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,ne,0,te):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,ne,0);else throw new Error("Unknown depthTexture format")}function xe(E){const x=n.get(E),V=E.isWebGLCubeRenderTarget===!0;if(E.depthTexture&&!x.__autoAllocateDepthBuffer){if(V)throw new Error("target.depthTexture not supported in Cube render targets");$e(x.__webglFramebuffer,E)}else if(V){x.__webglDepthbuffer=[];for(let ne=0;ne<6;ne++)t.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer[ne]),x.__webglDepthbuffer[ne]=i.createRenderbuffer(),I(x.__webglDepthbuffer[ne],E,!1)}else t.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer),x.__webglDepthbuffer=i.createRenderbuffer(),I(x.__webglDepthbuffer,E,!1);t.bindFramebuffer(i.FRAMEBUFFER,null)}function Re(E,x,V){const ne=n.get(E);x!==void 0&&Ne(ne.__webglFramebuffer,E,E.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D),V!==void 0&&xe(E)}function Me(E){const x=E.texture,V=n.get(E),ne=n.get(x);E.addEventListener("dispose",ie),E.isWebGLMultipleRenderTargets!==!0&&(ne.__webglTexture===void 0&&(ne.__webglTexture=i.createTexture()),ne.__version=x.version,o.memory.textures++);const te=E.isWebGLCubeRenderTarget===!0,b=E.isWebGLMultipleRenderTargets===!0,Z=T(E)||a;if(te){V.__webglFramebuffer=[];for(let Q=0;Q<6;Q++)V.__webglFramebuffer[Q]=i.createFramebuffer()}else{if(V.__webglFramebuffer=i.createFramebuffer(),b)if(r.drawBuffers){const Q=E.texture;for(let B=0,de=Q.length;B<de;B++){const _e=n.get(Q[B]);_e.__webglTexture===void 0&&(_e.__webglTexture=i.createTexture(),o.memory.textures++)}}else console.warn("THREE.WebGLRenderer: WebGLMultipleRenderTargets can only be used with WebGL2 or WEBGL_draw_buffers extension.");if(a&&E.samples>0&&Ge(E)===!1){const Q=b?x:[x];V.__webglMultisampledFramebuffer=i.createFramebuffer(),V.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,V.__webglMultisampledFramebuffer);for(let B=0;B<Q.length;B++){const de=Q[B];V.__webglColorRenderbuffer[B]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,V.__webglColorRenderbuffer[B]);const _e=s.convert(de.format,de.colorSpace),ge=s.convert(de.type),me=D(de.internalFormat,_e,ge,de.colorSpace,E.isXRRenderTarget===!0),ue=be(E);i.renderbufferStorageMultisample(i.RENDERBUFFER,ue,me,E.width,E.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+B,i.RENDERBUFFER,V.__webglColorRenderbuffer[B])}i.bindRenderbuffer(i.RENDERBUFFER,null),E.depthBuffer&&(V.__webglDepthRenderbuffer=i.createRenderbuffer(),I(V.__webglDepthRenderbuffer,E,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(te){t.bindTexture(i.TEXTURE_CUBE_MAP,ne.__webglTexture),ve(i.TEXTURE_CUBE_MAP,x,Z);for(let Q=0;Q<6;Q++)Ne(V.__webglFramebuffer[Q],E,x,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+Q);R(x,Z)&&P(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(b){const Q=E.texture;for(let B=0,de=Q.length;B<de;B++){const _e=Q[B],ge=n.get(_e);t.bindTexture(i.TEXTURE_2D,ge.__webglTexture),ve(i.TEXTURE_2D,_e,Z),Ne(V.__webglFramebuffer,E,_e,i.COLOR_ATTACHMENT0+B,i.TEXTURE_2D),R(_e,Z)&&P(i.TEXTURE_2D)}t.unbindTexture()}else{let Q=i.TEXTURE_2D;(E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(a?Q=E.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY:console.error("THREE.WebGLTextures: THREE.Data3DTexture and THREE.DataArrayTexture only supported with WebGL2.")),t.bindTexture(Q,ne.__webglTexture),ve(Q,x,Z),Ne(V.__webglFramebuffer,E,x,i.COLOR_ATTACHMENT0,Q),R(x,Z)&&P(Q),t.unbindTexture()}E.depthBuffer&&xe(E)}function He(E){const x=T(E)||a,V=E.isWebGLMultipleRenderTargets===!0?E.texture:[E.texture];for(let ne=0,te=V.length;ne<te;ne++){const b=V[ne];if(R(b,x)){const Z=E.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:i.TEXTURE_2D,Q=n.get(b).__webglTexture;t.bindTexture(Z,Q),P(Z),t.unbindTexture()}}}function De(E){if(a&&E.samples>0&&Ge(E)===!1){const x=E.isWebGLMultipleRenderTargets?E.texture:[E.texture],V=E.width,ne=E.height;let te=i.COLOR_BUFFER_BIT;const b=[],Z=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Q=n.get(E),B=E.isWebGLMultipleRenderTargets===!0;if(B)for(let de=0;de<x.length;de++)t.bindFramebuffer(i.FRAMEBUFFER,Q.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+de,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,Q.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+de,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,Q.__webglMultisampledFramebuffer),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Q.__webglFramebuffer);for(let de=0;de<x.length;de++){b.push(i.COLOR_ATTACHMENT0+de),E.depthBuffer&&b.push(Z);const _e=Q.__ignoreDepthValues!==void 0?Q.__ignoreDepthValues:!1;if(_e===!1&&(E.depthBuffer&&(te|=i.DEPTH_BUFFER_BIT),E.stencilBuffer&&(te|=i.STENCIL_BUFFER_BIT)),B&&i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Q.__webglColorRenderbuffer[de]),_e===!0&&(i.invalidateFramebuffer(i.READ_FRAMEBUFFER,[Z]),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[Z])),B){const ge=n.get(x[de]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,ge,0)}i.blitFramebuffer(0,0,V,ne,0,0,V,ne,te,i.NEAREST),m&&i.invalidateFramebuffer(i.READ_FRAMEBUFFER,b)}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),B)for(let de=0;de<x.length;de++){t.bindFramebuffer(i.FRAMEBUFFER,Q.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+de,i.RENDERBUFFER,Q.__webglColorRenderbuffer[de]);const _e=n.get(x[de]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,Q.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+de,i.TEXTURE_2D,_e,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Q.__webglMultisampledFramebuffer)}}function be(E){return Math.min(h,E.samples)}function Ge(E){const x=n.get(E);return a&&E.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&x.__useRenderToTexture!==!1}function Qe(E){const x=o.render.frame;g.get(E)!==x&&(g.set(E,x),E.update())}function nt(E,x){const V=E.colorSpace,ne=E.format,te=E.type;return E.isCompressedTexture===!0||E.format===Kr||V!==Ut&&V!==yn&&(V===Pe?a===!1?e.has("EXT_sRGB")===!0&&ne===Lt?(E.format=Kr,E.minFilter=yt,E.generateMipmaps=!1):x=ao.sRGBToLinear(x):(ne!==Lt||te!==an)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",V)),x}this.allocateTextureUnit=Y,this.resetTextureUnits=X,this.setTexture2D=j,this.setTexture2DArray=fe,this.setTexture3D=z,this.setTextureCube=J,this.rebindTextures=Re,this.setupRenderTarget=Me,this.updateRenderTargetMipmap=He,this.updateMultisampleRenderTarget=De,this.setupDepthRenderbuffer=xe,this.setupFrameBufferTexture=Ne,this.useMultisampledRTT=Ge}function Dd(i,e,t){const n=t.isWebGL2;function r(s,o=yn){let a;if(s===an)return i.UNSIGNED_BYTE;if(s===Ja)return i.UNSIGNED_SHORT_4_4_4_4;if(s===$a)return i.UNSIGNED_SHORT_5_5_5_1;if(s===pc)return i.BYTE;if(s===mc)return i.SHORT;if(s===is)return i.UNSIGNED_SHORT;if(s===ja)return i.INT;if(s===nn)return i.UNSIGNED_INT;if(s===rn)return i.FLOAT;if(s===mi)return n?i.HALF_FLOAT:(a=e.get("OES_texture_half_float"),a!==null?a.HALF_FLOAT_OES:null);if(s===gc)return i.ALPHA;if(s===Lt)return i.RGBA;if(s===_c)return i.LUMINANCE;if(s===vc)return i.LUMINANCE_ALPHA;if(s===Sn)return i.DEPTH_COMPONENT;if(s===ei)return i.DEPTH_STENCIL;if(s===Kr)return a=e.get("EXT_sRGB"),a!==null?a.SRGB_ALPHA_EXT:null;if(s===xc)return i.RED;if(s===Qa)return i.RED_INTEGER;if(s===Mc)return i.RG;if(s===eo)return i.RG_INTEGER;if(s===to)return i.RGBA_INTEGER;if(s===lr||s===ur||s===hr||s===fr)if(o===Pe)if(a=e.get("WEBGL_compressed_texture_s3tc_srgb"),a!==null){if(s===lr)return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(s===ur)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(s===hr)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(s===fr)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(a=e.get("WEBGL_compressed_texture_s3tc"),a!==null){if(s===lr)return a.COMPRESSED_RGB_S3TC_DXT1_EXT;if(s===ur)return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(s===hr)return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(s===fr)return a.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(s===ws||s===Rs||s===Cs||s===Ps)if(a=e.get("WEBGL_compressed_texture_pvrtc"),a!==null){if(s===ws)return a.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(s===Rs)return a.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(s===Cs)return a.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(s===Ps)return a.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(s===Sc)return a=e.get("WEBGL_compressed_texture_etc1"),a!==null?a.COMPRESSED_RGB_ETC1_WEBGL:null;if(s===Ls||s===Us)if(a=e.get("WEBGL_compressed_texture_etc"),a!==null){if(s===Ls)return o===Pe?a.COMPRESSED_SRGB8_ETC2:a.COMPRESSED_RGB8_ETC2;if(s===Us)return o===Pe?a.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:a.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(s===Ds||s===Is||s===Ns||s===Fs||s===Os||s===Bs||s===zs||s===Gs||s===Hs||s===Vs||s===ks||s===Ws||s===Xs||s===qs)if(a=e.get("WEBGL_compressed_texture_astc"),a!==null){if(s===Ds)return o===Pe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:a.COMPRESSED_RGBA_ASTC_4x4_KHR;if(s===Is)return o===Pe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:a.COMPRESSED_RGBA_ASTC_5x4_KHR;if(s===Ns)return o===Pe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:a.COMPRESSED_RGBA_ASTC_5x5_KHR;if(s===Fs)return o===Pe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:a.COMPRESSED_RGBA_ASTC_6x5_KHR;if(s===Os)return o===Pe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:a.COMPRESSED_RGBA_ASTC_6x6_KHR;if(s===Bs)return o===Pe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:a.COMPRESSED_RGBA_ASTC_8x5_KHR;if(s===zs)return o===Pe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:a.COMPRESSED_RGBA_ASTC_8x6_KHR;if(s===Gs)return o===Pe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:a.COMPRESSED_RGBA_ASTC_8x8_KHR;if(s===Hs)return o===Pe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:a.COMPRESSED_RGBA_ASTC_10x5_KHR;if(s===Vs)return o===Pe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:a.COMPRESSED_RGBA_ASTC_10x6_KHR;if(s===ks)return o===Pe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:a.COMPRESSED_RGBA_ASTC_10x8_KHR;if(s===Ws)return o===Pe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:a.COMPRESSED_RGBA_ASTC_10x10_KHR;if(s===Xs)return o===Pe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:a.COMPRESSED_RGBA_ASTC_12x10_KHR;if(s===qs)return o===Pe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:a.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(s===dr)if(a=e.get("EXT_texture_compression_bptc"),a!==null){if(s===dr)return o===Pe?a.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:a.COMPRESSED_RGBA_BPTC_UNORM_EXT}else return null;if(s===Ec||s===Ys||s===Zs||s===Ks)if(a=e.get("EXT_texture_compression_rgtc"),a!==null){if(s===dr)return a.COMPRESSED_RED_RGTC1_EXT;if(s===Ys)return a.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(s===Zs)return a.COMPRESSED_RED_GREEN_RGTC2_EXT;if(s===Ks)return a.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return s===Mn?n?i.UNSIGNED_INT_24_8:(a=e.get("WEBGL_depth_texture"),a!==null?a.UNSIGNED_INT_24_8_WEBGL:null):i[s]!==void 0?i[s]:null}return{convert:r}}class Id extends Tt{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class qi extends Mt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Nd={type:"move"};class Or{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new qi,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new qi,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new L,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new L),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new qi,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new L,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new L),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let r=null,s=null,o=null;const a=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){o=!0;for(const v of e.hand.values()){const p=t.getJointPose(v,n),d=this._getHandJoint(c,v);p!==null&&(d.matrix.fromArray(p.transform.matrix),d.matrix.decompose(d.position,d.rotation,d.scale),d.matrixWorldNeedsUpdate=!0,d.jointRadius=p.radius),d.visible=p!==null}const u=c.joints["index-finger-tip"],h=c.joints["thumb-tip"],f=u.position.distanceTo(h.position),m=.02,g=.005;c.inputState.pinching&&f>m+g?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&f<=m-g&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,n),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(r=t.getPose(e.targetRaySpace,n),r===null&&s!==null&&(r=s),r!==null&&(a.matrix.fromArray(r.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,r.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(r.linearVelocity)):a.hasLinearVelocity=!1,r.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(r.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(Nd)))}return a!==null&&(a.visible=r!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new qi;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}class Fd extends mt{constructor(e,t,n,r,s,o,a,l,c,u){if(u=u!==void 0?u:Sn,u!==Sn&&u!==ei)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&u===Sn&&(n=nn),n===void 0&&u===ei&&(n=Mn),super(null,r,s,o,a,l,u,n,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:dt,this.minFilter=l!==void 0?l:dt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}class Od extends Rn{constructor(e,t){super();const n=this;let r=null,s=1,o=null,a="local-floor",l=1,c=null,u=null,h=null,f=null,m=null,g=null;const v=t.getContextAttributes();let p=null,d=null;const y=[],_=[];let T=null;const A=new Tt;A.layers.enable(1),A.viewport=new ot;const R=new Tt;R.layers.enable(2),R.viewport=new ot;const P=[A,R],D=new Id;D.layers.enable(1),D.layers.enable(2);let M=null,w=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getCamera=function(){},this.setUserCamera=function(z){T=z},this.getController=function(z){let J=y[z];return J===void 0&&(J=new Or,y[z]=J),J.getTargetRaySpace()},this.getControllerGrip=function(z){let J=y[z];return J===void 0&&(J=new Or,y[z]=J),J.getGripSpace()},this.getHand=function(z){let J=y[z];return J===void 0&&(J=new Or,y[z]=J),J.getHandSpace()};function q(z){const J=_.indexOf(z.inputSource);if(J===-1)return;const $=y[J];$!==void 0&&($.update(z.inputSource,z.frame,c||o),$.dispatchEvent({type:z.type,data:z.inputSource}))}function ie(){r.removeEventListener("select",q),r.removeEventListener("selectstart",q),r.removeEventListener("selectend",q),r.removeEventListener("squeeze",q),r.removeEventListener("squeezestart",q),r.removeEventListener("squeezeend",q),r.removeEventListener("end",ie),r.removeEventListener("inputsourceschange",F);for(let z=0;z<y.length;z++){const J=_[z];J!==null&&(_[z]=null,y[z].disconnect(J))}M=null,w=null,e.setRenderTarget(p),m=null,f=null,h=null,r=null,d=null,fe.stop(),n.isPresenting=!1,n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(z){s=z,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(z){a=z,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function(z){c=z},this.getBaseLayer=function(){return f!==null?f:m},this.getBinding=function(){return h},this.getFrame=function(){return g},this.getSession=function(){return r},this.setSession=async function(z){if(r=z,r!==null){if(p=e.getRenderTarget(),r.addEventListener("select",q),r.addEventListener("selectstart",q),r.addEventListener("selectend",q),r.addEventListener("squeeze",q),r.addEventListener("squeezestart",q),r.addEventListener("squeezeend",q),r.addEventListener("end",ie),r.addEventListener("inputsourceschange",F),v.xrCompatible!==!0&&await t.makeXRCompatible(),r.renderState.layers===void 0||e.capabilities.isWebGL2===!1){const J={antialias:r.renderState.layers===void 0?v.antialias:!0,alpha:!0,depth:v.depth,stencil:v.stencil,framebufferScaleFactor:s};m=new XRWebGLLayer(r,t,J),r.updateRenderState({baseLayer:m}),d=new Tn(m.framebufferWidth,m.framebufferHeight,{format:Lt,type:an,colorSpace:e.outputColorSpace,stencilBuffer:v.stencil})}else{let J=null,$=null,ce=null;v.depth&&(ce=v.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,J=v.stencil?ei:Sn,$=v.stencil?Mn:nn);const le={colorFormat:t.RGBA8,depthFormat:ce,scaleFactor:s};h=new XRWebGLBinding(r,t),f=h.createProjectionLayer(le),r.updateRenderState({layers:[f]}),d=new Tn(f.textureWidth,f.textureHeight,{format:Lt,type:an,depthTexture:new Fd(f.textureWidth,f.textureHeight,$,void 0,void 0,void 0,void 0,void 0,void 0,J),stencilBuffer:v.stencil,colorSpace:e.outputColorSpace,samples:v.antialias?4:0});const ve=e.properties.get(d);ve.__ignoreDepthValues=f.ignoreDepthValues}d.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await r.requestReferenceSpace(a),fe.setContext(r),fe.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode};function F(z){for(let J=0;J<z.removed.length;J++){const $=z.removed[J],ce=_.indexOf($);ce>=0&&(_[ce]=null,y[ce].disconnect($))}for(let J=0;J<z.added.length;J++){const $=z.added[J];let ce=_.indexOf($);if(ce===-1){for(let ve=0;ve<y.length;ve++)if(ve>=_.length){_.push($),ce=ve;break}else if(_[ve]===null){_[ve]=$,ce=ve;break}if(ce===-1)break}const le=y[ce];le&&le.connect($)}}const G=new L,H=new L;function ee(z,J,$){G.setFromMatrixPosition(J.matrixWorld),H.setFromMatrixPosition($.matrixWorld);const ce=G.distanceTo(H),le=J.projectionMatrix.elements,ve=$.projectionMatrix.elements,Le=le[14]/(le[10]-1),Ee=le[14]/(le[10]+1),Ye=(le[9]+1)/le[5],Ne=(le[9]-1)/le[5],I=(le[8]-1)/le[0],$e=(ve[8]+1)/ve[0],xe=Le*I,Re=Le*$e,Me=ce/(-I+$e),He=Me*-I;J.matrixWorld.decompose(z.position,z.quaternion,z.scale),z.translateX(He),z.translateZ(Me),z.matrixWorld.compose(z.position,z.quaternion,z.scale),z.matrixWorldInverse.copy(z.matrixWorld).invert();const De=Le+Me,be=Ee+Me,Ge=xe-He,Qe=Re+(ce-He),nt=Ye*Ee/be*De,E=Ne*Ee/be*De;z.projectionMatrix.makePerspective(Ge,Qe,nt,E,De,be),z.projectionMatrixInverse.copy(z.projectionMatrix).invert()}function X(z,J){J===null?z.matrixWorld.copy(z.matrix):z.matrixWorld.multiplyMatrices(J.matrixWorld,z.matrix),z.matrixWorldInverse.copy(z.matrixWorld).invert()}this.updateCameraXR=function(z){if(r===null)return z;T&&(z=T),D.near=R.near=A.near=z.near,D.far=R.far=A.far=z.far,(M!==D.near||w!==D.far)&&(r.updateRenderState({depthNear:D.near,depthFar:D.far}),M=D.near,w=D.far);const J=z.parent,$=D.cameras;X(D,J);for(let ce=0;ce<$.length;ce++)X($[ce],J);return $.length===2?ee(D,A,R):D.projectionMatrix.copy(A.projectionMatrix),T&&Y(D,J),D};function Y(z,J){const $=T;J===null?$.matrix.copy(z.matrixWorld):($.matrix.copy(J.matrixWorld),$.matrix.invert(),$.matrix.multiply(z.matrixWorld)),$.matrix.decompose($.position,$.quaternion,$.scale),$.updateMatrixWorld(!0);const ce=$.children;for(let le=0,ve=ce.length;le<ve;le++)ce[le].updateMatrixWorld(!0);$.projectionMatrix.copy(z.projectionMatrix),$.projectionMatrixInverse.copy(z.projectionMatrixInverse),$.isPerspectiveCamera&&($.fov=jr*2*Math.atan(1/$.projectionMatrix.elements[5]),$.zoom=1)}this.getFoveation=function(){if(!(f===null&&m===null))return l},this.setFoveation=function(z){l=z,f!==null&&(f.fixedFoveation=z),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=z)};let K=null;function j(z,J){if(u=J.getViewerPose(c||o),g=J,u!==null){const $=u.views;m!==null&&(e.setRenderTargetFramebuffer(d,m.framebuffer),e.setRenderTarget(d));let ce=!1;$.length!==D.cameras.length&&(D.cameras.length=0,ce=!0);for(let le=0;le<$.length;le++){const ve=$[le];let Le=null;if(m!==null)Le=m.getViewport(ve);else{const Ye=h.getViewSubImage(f,ve);Le=Ye.viewport,le===0&&(e.setRenderTargetTextures(d,Ye.colorTexture,f.ignoreDepthValues?void 0:Ye.depthStencilTexture),e.setRenderTarget(d))}let Ee=P[le];Ee===void 0&&(Ee=new Tt,Ee.layers.enable(le),Ee.viewport=new ot,P[le]=Ee),Ee.matrix.fromArray(ve.transform.matrix),Ee.matrix.decompose(Ee.position,Ee.quaternion,Ee.scale),Ee.projectionMatrix.fromArray(ve.projectionMatrix),Ee.projectionMatrixInverse.copy(Ee.projectionMatrix).invert(),Ee.viewport.set(Le.x,Le.y,Le.width,Le.height),le===0&&(D.matrix.copy(Ee.matrix),D.matrix.decompose(D.position,D.quaternion,D.scale)),ce===!0&&D.cameras.push(Ee)}}for(let $=0;$<y.length;$++){const ce=_[$],le=y[$];ce!==null&&le!==void 0&&le.update(ce,J,c||o)}K&&K(z,J),J.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:J}),g=null}const fe=new xo;fe.setAnimationLoop(j),this.setAnimationLoop=function(z){K=z},this.dispose=function(){}}}function Bd(i,e){function t(p,d){p.matrixAutoUpdate===!0&&p.updateMatrix(),d.value.copy(p.matrix)}function n(p,d){d.color.getRGB(p.fogColor.value,mo(i)),d.isFog?(p.fogNear.value=d.near,p.fogFar.value=d.far):d.isFogExp2&&(p.fogDensity.value=d.density)}function r(p,d,y,_,T){d.isMeshBasicMaterial||d.isMeshLambertMaterial?s(p,d):d.isMeshToonMaterial?(s(p,d),h(p,d)):d.isMeshPhongMaterial?(s(p,d),u(p,d)):d.isMeshStandardMaterial?(s(p,d),f(p,d),d.isMeshPhysicalMaterial&&m(p,d,T)):d.isMeshMatcapMaterial?(s(p,d),g(p,d)):d.isMeshDepthMaterial?s(p,d):d.isMeshDistanceMaterial?(s(p,d),v(p,d)):d.isMeshNormalMaterial?s(p,d):d.isLineBasicMaterial?(o(p,d),d.isLineDashedMaterial&&a(p,d)):d.isPointsMaterial?l(p,d,y,_):d.isSpriteMaterial?c(p,d):d.isShadowMaterial?(p.color.value.copy(d.color),p.opacity.value=d.opacity):d.isShaderMaterial&&(d.uniformsNeedUpdate=!1)}function s(p,d){p.opacity.value=d.opacity,d.color&&p.diffuse.value.copy(d.color),d.emissive&&p.emissive.value.copy(d.emissive).multiplyScalar(d.emissiveIntensity),d.map&&(p.map.value=d.map,t(d.map,p.mapTransform)),d.alphaMap&&(p.alphaMap.value=d.alphaMap,t(d.alphaMap,p.alphaMapTransform)),d.bumpMap&&(p.bumpMap.value=d.bumpMap,t(d.bumpMap,p.bumpMapTransform),p.bumpScale.value=d.bumpScale,d.side===pt&&(p.bumpScale.value*=-1)),d.normalMap&&(p.normalMap.value=d.normalMap,t(d.normalMap,p.normalMapTransform),p.normalScale.value.copy(d.normalScale),d.side===pt&&p.normalScale.value.negate()),d.displacementMap&&(p.displacementMap.value=d.displacementMap,t(d.displacementMap,p.displacementMapTransform),p.displacementScale.value=d.displacementScale,p.displacementBias.value=d.displacementBias),d.emissiveMap&&(p.emissiveMap.value=d.emissiveMap,t(d.emissiveMap,p.emissiveMapTransform)),d.specularMap&&(p.specularMap.value=d.specularMap,t(d.specularMap,p.specularMapTransform)),d.alphaTest>0&&(p.alphaTest.value=d.alphaTest);const y=e.get(d).envMap;if(y&&(p.envMap.value=y,p.flipEnvMap.value=y.isCubeTexture&&y.isRenderTargetTexture===!1?-1:1,p.reflectivity.value=d.reflectivity,p.ior.value=d.ior,p.refractionRatio.value=d.refractionRatio),d.lightMap){p.lightMap.value=d.lightMap;const _=i.useLegacyLights===!0?Math.PI:1;p.lightMapIntensity.value=d.lightMapIntensity*_,t(d.lightMap,p.lightMapTransform)}d.aoMap&&(p.aoMap.value=d.aoMap,p.aoMapIntensity.value=d.aoMapIntensity,t(d.aoMap,p.aoMapTransform))}function o(p,d){p.diffuse.value.copy(d.color),p.opacity.value=d.opacity,d.map&&(p.map.value=d.map,t(d.map,p.mapTransform))}function a(p,d){p.dashSize.value=d.dashSize,p.totalSize.value=d.dashSize+d.gapSize,p.scale.value=d.scale}function l(p,d,y,_){p.diffuse.value.copy(d.color),p.opacity.value=d.opacity,p.size.value=d.size*y,p.scale.value=_*.5,d.map&&(p.map.value=d.map,t(d.map,p.uvTransform)),d.alphaMap&&(p.alphaMap.value=d.alphaMap,t(d.alphaMap,p.alphaMapTransform)),d.alphaTest>0&&(p.alphaTest.value=d.alphaTest)}function c(p,d){p.diffuse.value.copy(d.color),p.opacity.value=d.opacity,p.rotation.value=d.rotation,d.map&&(p.map.value=d.map,t(d.map,p.mapTransform)),d.alphaMap&&(p.alphaMap.value=d.alphaMap,t(d.alphaMap,p.alphaMapTransform)),d.alphaTest>0&&(p.alphaTest.value=d.alphaTest)}function u(p,d){p.specular.value.copy(d.specular),p.shininess.value=Math.max(d.shininess,1e-4)}function h(p,d){d.gradientMap&&(p.gradientMap.value=d.gradientMap)}function f(p,d){p.metalness.value=d.metalness,d.metalnessMap&&(p.metalnessMap.value=d.metalnessMap,t(d.metalnessMap,p.metalnessMapTransform)),p.roughness.value=d.roughness,d.roughnessMap&&(p.roughnessMap.value=d.roughnessMap,t(d.roughnessMap,p.roughnessMapTransform)),e.get(d).envMap&&(p.envMapIntensity.value=d.envMapIntensity)}function m(p,d,y){p.ior.value=d.ior,d.sheen>0&&(p.sheenColor.value.copy(d.sheenColor).multiplyScalar(d.sheen),p.sheenRoughness.value=d.sheenRoughness,d.sheenColorMap&&(p.sheenColorMap.value=d.sheenColorMap,t(d.sheenColorMap,p.sheenColorMapTransform)),d.sheenRoughnessMap&&(p.sheenRoughnessMap.value=d.sheenRoughnessMap,t(d.sheenRoughnessMap,p.sheenRoughnessMapTransform))),d.clearcoat>0&&(p.clearcoat.value=d.clearcoat,p.clearcoatRoughness.value=d.clearcoatRoughness,d.clearcoatMap&&(p.clearcoatMap.value=d.clearcoatMap,t(d.clearcoatMap,p.clearcoatMapTransform)),d.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=d.clearcoatRoughnessMap,t(d.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),d.clearcoatNormalMap&&(p.clearcoatNormalMap.value=d.clearcoatNormalMap,t(d.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(d.clearcoatNormalScale),d.side===pt&&p.clearcoatNormalScale.value.negate())),d.iridescence>0&&(p.iridescence.value=d.iridescence,p.iridescenceIOR.value=d.iridescenceIOR,p.iridescenceThicknessMinimum.value=d.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=d.iridescenceThicknessRange[1],d.iridescenceMap&&(p.iridescenceMap.value=d.iridescenceMap,t(d.iridescenceMap,p.iridescenceMapTransform)),d.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=d.iridescenceThicknessMap,t(d.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),d.transmission>0&&(p.transmission.value=d.transmission,p.transmissionSamplerMap.value=y.texture,p.transmissionSamplerSize.value.set(y.width,y.height),d.transmissionMap&&(p.transmissionMap.value=d.transmissionMap,t(d.transmissionMap,p.transmissionMapTransform)),p.thickness.value=d.thickness,d.thicknessMap&&(p.thicknessMap.value=d.thicknessMap,t(d.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=d.attenuationDistance,p.attenuationColor.value.copy(d.attenuationColor)),d.anisotropy>0&&(p.anisotropyVector.value.set(d.anisotropy*Math.cos(d.anisotropyRotation),d.anisotropy*Math.sin(d.anisotropyRotation)),d.anisotropyMap&&(p.anisotropyMap.value=d.anisotropyMap,t(d.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=d.specularIntensity,p.specularColor.value.copy(d.specularColor),d.specularColorMap&&(p.specularColorMap.value=d.specularColorMap,t(d.specularColorMap,p.specularColorMapTransform)),d.specularIntensityMap&&(p.specularIntensityMap.value=d.specularIntensityMap,t(d.specularIntensityMap,p.specularIntensityMapTransform))}function g(p,d){d.matcap&&(p.matcap.value=d.matcap)}function v(p,d){const y=e.get(d).light;p.referencePosition.value.setFromMatrixPosition(y.matrixWorld),p.nearDistance.value=y.shadow.camera.near,p.farDistance.value=y.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function zd(i,e,t,n){let r={},s={},o=[];const a=t.isWebGL2?i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS):0;function l(y,_){const T=_.program;n.uniformBlockBinding(y,T)}function c(y,_){let T=r[y.id];T===void 0&&(g(y),T=u(y),r[y.id]=T,y.addEventListener("dispose",p));const A=_.program;n.updateUBOMapping(y,A);const R=e.render.frame;s[y.id]!==R&&(f(y),s[y.id]=R)}function u(y){const _=h();y.__bindingPointIndex=_;const T=i.createBuffer(),A=y.__size,R=y.usage;return i.bindBuffer(i.UNIFORM_BUFFER,T),i.bufferData(i.UNIFORM_BUFFER,A,R),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,_,T),T}function h(){for(let y=0;y<a;y++)if(o.indexOf(y)===-1)return o.push(y),y;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(y){const _=r[y.id],T=y.uniforms,A=y.__cache;i.bindBuffer(i.UNIFORM_BUFFER,_);for(let R=0,P=T.length;R<P;R++){const D=T[R];if(m(D,R,A)===!0){const M=D.__offset,w=Array.isArray(D.value)?D.value:[D.value];let q=0;for(let ie=0;ie<w.length;ie++){const F=w[ie],G=v(F);typeof F=="number"?(D.__data[0]=F,i.bufferSubData(i.UNIFORM_BUFFER,M+q,D.__data)):F.isMatrix3?(D.__data[0]=F.elements[0],D.__data[1]=F.elements[1],D.__data[2]=F.elements[2],D.__data[3]=F.elements[0],D.__data[4]=F.elements[3],D.__data[5]=F.elements[4],D.__data[6]=F.elements[5],D.__data[7]=F.elements[0],D.__data[8]=F.elements[6],D.__data[9]=F.elements[7],D.__data[10]=F.elements[8],D.__data[11]=F.elements[0]):(F.toArray(D.__data,q),q+=G.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,M,D.__data)}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function m(y,_,T){const A=y.value;if(T[_]===void 0){if(typeof A=="number")T[_]=A;else{const R=Array.isArray(A)?A:[A],P=[];for(let D=0;D<R.length;D++)P.push(R[D].clone());T[_]=P}return!0}else if(typeof A=="number"){if(T[_]!==A)return T[_]=A,!0}else{const R=Array.isArray(T[_])?T[_]:[T[_]],P=Array.isArray(A)?A:[A];for(let D=0;D<R.length;D++){const M=R[D];if(M.equals(P[D])===!1)return M.copy(P[D]),!0}}return!1}function g(y){const _=y.uniforms;let T=0;const A=16;let R=0;for(let P=0,D=_.length;P<D;P++){const M=_[P],w={boundary:0,storage:0},q=Array.isArray(M.value)?M.value:[M.value];for(let ie=0,F=q.length;ie<F;ie++){const G=q[ie],H=v(G);w.boundary+=H.boundary,w.storage+=H.storage}if(M.__data=new Float32Array(w.storage/Float32Array.BYTES_PER_ELEMENT),M.__offset=T,P>0){R=T%A;const ie=A-R;R!==0&&ie-w.boundary<0&&(T+=A-R,M.__offset=T)}T+=w.storage}return R=T%A,R>0&&(T+=A-R),y.__size=T,y.__cache={},this}function v(y){const _={boundary:0,storage:0};return typeof y=="number"?(_.boundary=4,_.storage=4):y.isVector2?(_.boundary=8,_.storage=8):y.isVector3||y.isColor?(_.boundary=16,_.storage=12):y.isVector4?(_.boundary=16,_.storage=16):y.isMatrix3?(_.boundary=48,_.storage=48):y.isMatrix4?(_.boundary=64,_.storage=64):y.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",y),_}function p(y){const _=y.target;_.removeEventListener("dispose",p);const T=o.indexOf(_.__bindingPointIndex);o.splice(T,1),i.deleteBuffer(r[_.id]),delete r[_.id],delete s[_.id]}function d(){for(const y in r)i.deleteBuffer(r[y]);o=[],r={},s={}}return{bind:l,update:c,dispose:d}}function Gd(){const i=gi("canvas");return i.style.display="block",i}class To{constructor(e={}){const{canvas:t=Gd(),context:n=null,depth:r=!0,stencil:s=!0,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:h=!1}=e;this.isWebGLRenderer=!0;let f;n!==null?f=n.getContextAttributes().alpha:f=o;const m=new Uint32Array(4),g=new Int32Array(4);let v=null,p=null;const d=[],y=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.outputColorSpace=Pe,this.useLegacyLights=!0,this.toneMapping=Jt,this.toneMappingExposure=1;const _=this;let T=!1,A=0,R=0,P=null,D=-1,M=null;const w=new ot,q=new ot;let ie=null;const F=new Ve(0);let G=0,H=t.width,ee=t.height,X=1,Y=null,K=null;const j=new ot(0,0,H,ee),fe=new ot(0,0,H,ee);let z=!1;const J=new vo;let $=!1,ce=!1,le=null;const ve=new st,Le=new pe,Ee=new L,Ye={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};function Ne(){return P===null?X:1}let I=n;function $e(S,N){for(let k=0;k<S.length;k++){const U=S[k],W=t.getContext(U,N);if(W!==null)return W}return null}try{const S={alpha:!0,depth:r,stencil:s,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:h};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${ns}`),t.addEventListener("webglcontextlost",ae,!1),t.addEventListener("webglcontextrestored",O,!1),t.addEventListener("webglcontextcreationerror",re,!1),I===null){const N=["webgl2","webgl","experimental-webgl"];if(_.isWebGL1Renderer===!0&&N.shift(),I=$e(N,S),I===null)throw $e(N)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}I instanceof WebGLRenderingContext&&console.warn("THREE.WebGLRenderer: WebGL 1 support was deprecated in r153 and will be removed in r163."),I.getShaderPrecisionFormat===void 0&&(I.getShaderPrecisionFormat=function(){return{rangeMin:1,rangeMax:1,precision:1}})}catch(S){throw console.error("THREE.WebGLRenderer: "+S.message),S}let xe,Re,Me,He,De,be,Ge,Qe,nt,E,x,V,ne,te,b,Z,Q,B,de,_e,ge,me,ue,ye;function Oe(){xe=new jh(I),Re=new kh(I,xe,e),xe.init(Re),me=new Dd(I,xe,Re),Me=new Ld(I,xe,Re),He=new Qh(I),De=new _d,be=new Ud(I,xe,Me,De,Re,me,He),Ge=new Xh(_),Qe=new Kh(_),nt=new ul(I,Re),ue=new Hh(I,xe,nt,Re),E=new Jh(I,nt,He,ue),x=new rf(I,E,nt,He),de=new nf(I,Re,be),Z=new Wh(De),V=new gd(_,Ge,Qe,xe,Re,ue,Z),ne=new Bd(_,De),te=new xd,b=new Ad(xe,Re),B=new Gh(_,Ge,Qe,Me,x,f,l),Q=new Pd(_,x,Re),ye=new zd(I,He,Re,Me),_e=new Vh(I,xe,He,Re),ge=new $h(I,xe,He,Re),He.programs=V.programs,_.capabilities=Re,_.extensions=xe,_.properties=De,_.renderLists=te,_.shadowMap=Q,_.state=Me,_.info=He}Oe();const C=new Od(_,I);this.xr=C,this.getContext=function(){return I},this.getContextAttributes=function(){return I.getContextAttributes()},this.forceContextLoss=function(){const S=xe.get("WEBGL_lose_context");S&&S.loseContext()},this.forceContextRestore=function(){const S=xe.get("WEBGL_lose_context");S&&S.restoreContext()},this.getPixelRatio=function(){return X},this.setPixelRatio=function(S){S!==void 0&&(X=S,this.setSize(H,ee,!1))},this.getSize=function(S){return S.set(H,ee)},this.setSize=function(S,N,k=!0){if(C.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}H=S,ee=N,t.width=Math.floor(S*X),t.height=Math.floor(N*X),k===!0&&(t.style.width=S+"px",t.style.height=N+"px"),this.setViewport(0,0,S,N)},this.getDrawingBufferSize=function(S){return S.set(H*X,ee*X).floor()},this.setDrawingBufferSize=function(S,N,k){H=S,ee=N,X=k,t.width=Math.floor(S*k),t.height=Math.floor(N*k),this.setViewport(0,0,S,N)},this.getCurrentViewport=function(S){return S.copy(w)},this.getViewport=function(S){return S.copy(j)},this.setViewport=function(S,N,k,U){S.isVector4?j.set(S.x,S.y,S.z,S.w):j.set(S,N,k,U),Me.viewport(w.copy(j).multiplyScalar(X).floor())},this.getScissor=function(S){return S.copy(fe)},this.setScissor=function(S,N,k,U){S.isVector4?fe.set(S.x,S.y,S.z,S.w):fe.set(S,N,k,U),Me.scissor(q.copy(fe).multiplyScalar(X).floor())},this.getScissorTest=function(){return z},this.setScissorTest=function(S){Me.setScissorTest(z=S)},this.setOpaqueSort=function(S){Y=S},this.setTransparentSort=function(S){K=S},this.getClearColor=function(S){return S.copy(B.getClearColor())},this.setClearColor=function(){B.setClearColor.apply(B,arguments)},this.getClearAlpha=function(){return B.getClearAlpha()},this.setClearAlpha=function(){B.setClearAlpha.apply(B,arguments)},this.clear=function(S=!0,N=!0,k=!0){let U=0;if(S){let W=!1;if(P!==null){const he=P.texture.format;W=he===to||he===eo||he===Qa}if(W){const he=P.texture.type,Se=he===an||he===nn||he===is||he===Mn||he===Ja||he===$a,Te=B.getClearColor(),Ae=B.getClearAlpha(),Fe=Te.r,we=Te.g,Ce=Te.b,ke=De.get(P).__webglFramebuffer;Se?(m[0]=Fe,m[1]=we,m[2]=Ce,m[3]=Ae,I.clearBufferuiv(I.COLOR,ke,m)):(g[0]=Fe,g[1]=we,g[2]=Ce,g[3]=Ae,I.clearBufferiv(I.COLOR,ke,g))}else U|=I.COLOR_BUFFER_BIT}N&&(U|=I.DEPTH_BUFFER_BIT),k&&(U|=I.STENCIL_BUFFER_BIT),I.clear(U)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",ae,!1),t.removeEventListener("webglcontextrestored",O,!1),t.removeEventListener("webglcontextcreationerror",re,!1),te.dispose(),b.dispose(),De.dispose(),Ge.dispose(),Qe.dispose(),x.dispose(),ue.dispose(),ye.dispose(),V.dispose(),C.dispose(),C.removeEventListener("sessionstart",qe),C.removeEventListener("sessionend",Dt),le&&(le.dispose(),le=null),ut.stop()};function ae(S){S.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),T=!0}function O(){console.log("THREE.WebGLRenderer: Context Restored."),T=!1;const S=He.autoReset,N=Q.enabled,k=Q.autoUpdate,U=Q.needsUpdate,W=Q.type;Oe(),He.autoReset=S,Q.enabled=N,Q.autoUpdate=k,Q.needsUpdate=U,Q.type=W}function re(S){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",S.statusMessage)}function oe(S){const N=S.target;N.removeEventListener("dispose",oe),ze(N)}function ze(S){Xe(S),De.remove(S)}function Xe(S){const N=De.get(S).programs;N!==void 0&&(N.forEach(function(k){V.releaseProgram(k)}),S.isShaderMaterial&&V.releaseShaderCache(S))}this.renderBufferDirect=function(S,N,k,U,W,he){N===null&&(N=Ye);const Se=W.isMesh&&W.matrixWorld.determinant()<0,Te=Io(S,N,k,U,W);Me.setMaterial(U,Se);let Ae=k.index,Fe=1;U.wireframe===!0&&(Ae=E.getWireframeAttribute(k),Fe=2);const we=k.drawRange,Ce=k.attributes.position;let ke=we.start*Fe,Ze=(we.start+we.count)*Fe;he!==null&&(ke=Math.max(ke,he.start*Fe),Ze=Math.min(Ze,(he.start+he.count)*Fe)),Ae!==null?(ke=Math.max(ke,0),Ze=Math.min(Ze,Ae.count)):Ce!=null&&(ke=Math.max(ke,0),Ze=Math.min(Ze,Ce.count));const At=Ze-ke;if(At<0||At===1/0)return;ue.setup(W,U,Te,k,Ae);let zt,je=_e;if(Ae!==null&&(zt=nt.get(Ae),je=ge,je.setIndex(zt)),W.isMesh)U.wireframe===!0?(Me.setLineWidth(U.wireframeLinewidth*Ne()),je.setMode(I.LINES)):je.setMode(I.TRIANGLES);else if(W.isLine){let Be=U.linewidth;Be===void 0&&(Be=1),Me.setLineWidth(Be*Ne()),W.isLineSegments?je.setMode(I.LINES):W.isLineLoop?je.setMode(I.LINE_LOOP):je.setMode(I.LINE_STRIP)}else W.isPoints?je.setMode(I.POINTS):W.isSprite&&je.setMode(I.TRIANGLES);if(W.isInstancedMesh)je.renderInstances(ke,At,W.count);else if(k.isInstancedBufferGeometry){const Be=k._maxInstanceCount!==void 0?k._maxInstanceCount:1/0,rr=Math.min(k.instanceCount,Be);je.renderInstances(ke,At,rr)}else je.render(ke,At)},this.compile=function(S,N){function k(U,W,he){U.transparent===!0&&U.side===Zt&&U.forceSinglePass===!1?(U.side=pt,U.needsUpdate=!0,Ti(U,W,he),U.side=on,U.needsUpdate=!0,Ti(U,W,he),U.side=Zt):Ti(U,W,he)}p=b.get(S),p.init(),y.push(p),S.traverseVisible(function(U){U.isLight&&U.layers.test(N.layers)&&(p.pushLight(U),U.castShadow&&p.pushShadow(U))}),p.setupLights(_.useLegacyLights),S.traverse(function(U){const W=U.material;if(W)if(Array.isArray(W))for(let he=0;he<W.length;he++){const Se=W[he];k(Se,S,U)}else k(W,S,U)}),y.pop(),p=null};let Ke=null;function un(S){Ke&&Ke(S)}function qe(){ut.stop()}function Dt(){ut.start()}const ut=new xo;ut.setAnimationLoop(un),typeof self<"u"&&ut.setContext(self),this.setAnimationLoop=function(S){Ke=S,C.setAnimationLoop(S),S===null?ut.stop():ut.start()},C.addEventListener("sessionstart",qe),C.addEventListener("sessionend",Dt),this.render=function(S,N){if(N!==void 0&&N.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(T===!0)return;S.matrixWorldAutoUpdate===!0&&S.updateMatrixWorld(),N.parent===null&&N.matrixWorldAutoUpdate===!0&&N.updateMatrixWorld(),C.enabled===!0&&C.isPresenting===!0&&(N=C.updateCameraXR(N)),S.isScene===!0&&S.onBeforeRender(_,S,N,P),p=b.get(S,y.length),p.init(),y.push(p),ve.multiplyMatrices(N.projectionMatrix,N.matrixWorldInverse),J.setFromProjectionMatrix(ve),ce=this.localClippingEnabled,$=Z.init(this.clippingPlanes,ce),v=te.get(S,d.length),v.init(),d.push(v),ps(S,N,0,_.sortObjects),v.finish(),_.sortObjects===!0&&v.sort(Y,K),$===!0&&Z.beginShadows();const k=p.state.shadowsArray;if(Q.render(k,S,N),$===!0&&Z.endShadows(),this.info.autoReset===!0&&this.info.reset(),this.info.render.frame++,B.render(v,S),p.setupLights(_.useLegacyLights),N.isArrayCamera){const U=N.cameras;for(let W=0,he=U.length;W<he;W++){const Se=U[W];ms(v,S,Se,Se.viewport)}}else ms(v,S,N);P!==null&&(be.updateMultisampleRenderTarget(P),be.updateRenderTargetMipmap(P)),S.isScene===!0&&S.onAfterRender(_,S,N),ue.resetDefaultState(),D=-1,M=null,y.pop(),y.length>0?p=y[y.length-1]:p=null,d.pop(),d.length>0?v=d[d.length-1]:v=null};function ps(S,N,k,U){if(S.visible===!1)return;if(S.layers.test(N.layers)){if(S.isGroup)k=S.renderOrder;else if(S.isLOD)S.autoUpdate===!0&&S.update(N);else if(S.isLight)p.pushLight(S),S.castShadow&&p.pushShadow(S);else if(S.isSprite){if(!S.frustumCulled||J.intersectsSprite(S)){U&&Ee.setFromMatrixPosition(S.matrixWorld).applyMatrix4(ve);const Se=x.update(S),Te=S.material;Te.visible&&v.push(S,Se,Te,k,Ee.z,null)}}else if((S.isMesh||S.isLine||S.isPoints)&&(!S.frustumCulled||J.intersectsObject(S))){S.isSkinnedMesh&&S.skeleton.frame!==He.render.frame&&(S.skeleton.update(),S.skeleton.frame=He.render.frame);const Se=x.update(S),Te=S.material;if(U&&(S.boundingSphere!==void 0?(S.boundingSphere===null&&S.computeBoundingSphere(),Ee.copy(S.boundingSphere.center)):(Se.boundingSphere===null&&Se.computeBoundingSphere(),Ee.copy(Se.boundingSphere.center)),Ee.applyMatrix4(S.matrixWorld).applyMatrix4(ve)),Array.isArray(Te)){const Ae=Se.groups;for(let Fe=0,we=Ae.length;Fe<we;Fe++){const Ce=Ae[Fe],ke=Te[Ce.materialIndex];ke&&ke.visible&&v.push(S,Se,ke,k,Ee.z,Ce)}}else Te.visible&&v.push(S,Se,Te,k,Ee.z,null)}}const he=S.children;for(let Se=0,Te=he.length;Se<Te;Se++)ps(he[Se],N,k,U)}function ms(S,N,k,U){const W=S.opaque,he=S.transmissive,Se=S.transparent;p.setupLightsView(k),$===!0&&Z.setGlobalState(_.clippingPlanes,k),he.length>0&&Do(W,he,N,k),U&&Me.viewport(w.copy(U)),W.length>0&&yi(W,N,k),he.length>0&&yi(he,N,k),Se.length>0&&yi(Se,N,k),Me.buffers.depth.setTest(!0),Me.buffers.depth.setMask(!0),Me.buffers.color.setMask(!0),Me.setPolygonOffset(!1)}function Do(S,N,k,U){const W=Re.isWebGL2;le===null&&(le=new Tn(1,1,{generateMipmaps:!0,type:xe.has("EXT_color_buffer_half_float")?mi:an,minFilter:pi,samples:W&&a===!0?4:0})),_.getDrawingBufferSize(Le),W?le.setSize(Le.x,Le.y):le.setSize(Jr(Le.x),Jr(Le.y));const he=_.getRenderTarget();_.setRenderTarget(le),_.getClearColor(F),G=_.getClearAlpha(),G<1&&_.setClearColor(16777215,.5),_.clear();const Se=_.toneMapping;_.toneMapping=Jt,yi(S,k,U),be.updateMultisampleRenderTarget(le),be.updateRenderTargetMipmap(le);let Te=!1;for(let Ae=0,Fe=N.length;Ae<Fe;Ae++){const we=N[Ae],Ce=we.object,ke=we.geometry,Ze=we.material,At=we.group;if(Ze.side===Zt&&Ce.layers.test(U.layers)){const zt=Ze.side;Ze.side=pt,Ze.needsUpdate=!0,gs(Ce,k,U,ke,Ze,At),Ze.side=zt,Ze.needsUpdate=!0,Te=!0}}Te===!0&&(be.updateMultisampleRenderTarget(le),be.updateRenderTargetMipmap(le)),_.setRenderTarget(he),_.setClearColor(F,G),_.toneMapping=Se}function yi(S,N,k){const U=N.isScene===!0?N.overrideMaterial:null;for(let W=0,he=S.length;W<he;W++){const Se=S[W],Te=Se.object,Ae=Se.geometry,Fe=U===null?Se.material:U,we=Se.group;Te.layers.test(k.layers)&&gs(Te,N,k,Ae,Fe,we)}}function gs(S,N,k,U,W,he){S.onBeforeRender(_,N,k,U,W,he),S.modelViewMatrix.multiplyMatrices(k.matrixWorldInverse,S.matrixWorld),S.normalMatrix.getNormalMatrix(S.modelViewMatrix),W.onBeforeRender(_,N,k,U,S,he),W.transparent===!0&&W.side===Zt&&W.forceSinglePass===!1?(W.side=pt,W.needsUpdate=!0,_.renderBufferDirect(k,N,U,W,S,he),W.side=on,W.needsUpdate=!0,_.renderBufferDirect(k,N,U,W,S,he),W.side=Zt):_.renderBufferDirect(k,N,U,W,S,he),S.onAfterRender(_,N,k,U,W,he)}function Ti(S,N,k){N.isScene!==!0&&(N=Ye);const U=De.get(S),W=p.state.lights,he=p.state.shadowsArray,Se=W.state.version,Te=V.getParameters(S,W.state,he,N,k),Ae=V.getProgramCacheKey(Te);let Fe=U.programs;U.environment=S.isMeshStandardMaterial?N.environment:null,U.fog=N.fog,U.envMap=(S.isMeshStandardMaterial?Qe:Ge).get(S.envMap||U.environment),Fe===void 0&&(S.addEventListener("dispose",oe),Fe=new Map,U.programs=Fe);let we=Fe.get(Ae);if(we!==void 0){if(U.currentProgram===we&&U.lightsStateVersion===Se)return _s(S,Te),we}else Te.uniforms=V.getUniforms(S),S.onBuild(k,Te,_),S.onBeforeCompile(Te,_),we=V.acquireProgram(Te,Ae),Fe.set(Ae,we),U.uniforms=Te.uniforms;const Ce=U.uniforms;(!S.isShaderMaterial&&!S.isRawShaderMaterial||S.clipping===!0)&&(Ce.clippingPlanes=Z.uniform),_s(S,Te),U.needsLights=Fo(S),U.lightsStateVersion=Se,U.needsLights&&(Ce.ambientLightColor.value=W.state.ambient,Ce.lightProbe.value=W.state.probe,Ce.directionalLights.value=W.state.directional,Ce.directionalLightShadows.value=W.state.directionalShadow,Ce.spotLights.value=W.state.spot,Ce.spotLightShadows.value=W.state.spotShadow,Ce.rectAreaLights.value=W.state.rectArea,Ce.ltc_1.value=W.state.rectAreaLTC1,Ce.ltc_2.value=W.state.rectAreaLTC2,Ce.pointLights.value=W.state.point,Ce.pointLightShadows.value=W.state.pointShadow,Ce.hemisphereLights.value=W.state.hemi,Ce.directionalShadowMap.value=W.state.directionalShadowMap,Ce.directionalShadowMatrix.value=W.state.directionalShadowMatrix,Ce.spotShadowMap.value=W.state.spotShadowMap,Ce.spotLightMatrix.value=W.state.spotLightMatrix,Ce.spotLightMap.value=W.state.spotLightMap,Ce.pointShadowMap.value=W.state.pointShadowMap,Ce.pointShadowMatrix.value=W.state.pointShadowMatrix);const ke=we.getUniforms(),Ze=ji.seqWithValue(ke.seq,Ce);return U.currentProgram=we,U.uniformsList=Ze,we}function _s(S,N){const k=De.get(S);k.outputColorSpace=N.outputColorSpace,k.instancing=N.instancing,k.skinning=N.skinning,k.morphTargets=N.morphTargets,k.morphNormals=N.morphNormals,k.morphColors=N.morphColors,k.morphTargetsCount=N.morphTargetsCount,k.numClippingPlanes=N.numClippingPlanes,k.numIntersection=N.numClipIntersection,k.vertexAlphas=N.vertexAlphas,k.vertexTangents=N.vertexTangents,k.toneMapping=N.toneMapping}function Io(S,N,k,U,W){N.isScene!==!0&&(N=Ye),be.resetTextureUnits();const he=N.fog,Se=U.isMeshStandardMaterial?N.environment:null,Te=P===null?_.outputColorSpace:P.isXRRenderTarget===!0?P.texture.colorSpace:Ut,Ae=(U.isMeshStandardMaterial?Qe:Ge).get(U.envMap||Se),Fe=U.vertexColors===!0&&!!k.attributes.color&&k.attributes.color.itemSize===4,we=!!k.attributes.tangent&&(!!U.normalMap||U.anisotropy>0),Ce=!!k.morphAttributes.position,ke=!!k.morphAttributes.normal,Ze=!!k.morphAttributes.color,At=U.toneMapped?_.toneMapping:Jt,zt=k.morphAttributes.position||k.morphAttributes.normal||k.morphAttributes.color,je=zt!==void 0?zt.length:0,Be=De.get(U),rr=p.state.lights;if($===!0&&(ce===!0||S!==M)){const gt=S===M&&U.id===D;Z.setState(U,S,gt)}let it=!1;U.version===Be.__version?(Be.needsLights&&Be.lightsStateVersion!==rr.state.version||Be.outputColorSpace!==Te||W.isInstancedMesh&&Be.instancing===!1||!W.isInstancedMesh&&Be.instancing===!0||W.isSkinnedMesh&&Be.skinning===!1||!W.isSkinnedMesh&&Be.skinning===!0||Be.envMap!==Ae||U.fog===!0&&Be.fog!==he||Be.numClippingPlanes!==void 0&&(Be.numClippingPlanes!==Z.numPlanes||Be.numIntersection!==Z.numIntersection)||Be.vertexAlphas!==Fe||Be.vertexTangents!==we||Be.morphTargets!==Ce||Be.morphNormals!==ke||Be.morphColors!==Ze||Be.toneMapping!==At||Re.isWebGL2===!0&&Be.morphTargetsCount!==je)&&(it=!0):(it=!0,Be.__version=U.version);let hn=Be.currentProgram;it===!0&&(hn=Ti(U,N,W));let vs=!1,si=!1,sr=!1;const ht=hn.getUniforms(),fn=Be.uniforms;if(Me.useProgram(hn.program)&&(vs=!0,si=!0,sr=!0),U.id!==D&&(D=U.id,si=!0),vs||M!==S){if(ht.setValue(I,"projectionMatrix",S.projectionMatrix),Re.logarithmicDepthBuffer&&ht.setValue(I,"logDepthBufFC",2/(Math.log(S.far+1)/Math.LN2)),M!==S&&(M=S,si=!0,sr=!0),U.isShaderMaterial||U.isMeshPhongMaterial||U.isMeshToonMaterial||U.isMeshStandardMaterial||U.envMap){const gt=ht.map.cameraPosition;gt!==void 0&&gt.setValue(I,Ee.setFromMatrixPosition(S.matrixWorld))}(U.isMeshPhongMaterial||U.isMeshToonMaterial||U.isMeshLambertMaterial||U.isMeshBasicMaterial||U.isMeshStandardMaterial||U.isShaderMaterial)&&ht.setValue(I,"isOrthographic",S.isOrthographicCamera===!0),(U.isMeshPhongMaterial||U.isMeshToonMaterial||U.isMeshLambertMaterial||U.isMeshBasicMaterial||U.isMeshStandardMaterial||U.isShaderMaterial||U.isShadowMaterial||W.isSkinnedMesh)&&ht.setValue(I,"viewMatrix",S.matrixWorldInverse)}if(W.isSkinnedMesh){ht.setOptional(I,W,"bindMatrix"),ht.setOptional(I,W,"bindMatrixInverse");const gt=W.skeleton;gt&&(Re.floatVertexTextures?(gt.boneTexture===null&&gt.computeBoneTexture(),ht.setValue(I,"boneTexture",gt.boneTexture,be),ht.setValue(I,"boneTextureSize",gt.boneTextureSize)):console.warn("THREE.WebGLRenderer: SkinnedMesh can only be used with WebGL 2. With WebGL 1 OES_texture_float and vertex textures support is required."))}const ar=k.morphAttributes;if((ar.position!==void 0||ar.normal!==void 0||ar.color!==void 0&&Re.isWebGL2===!0)&&de.update(W,k,hn),(si||Be.receiveShadow!==W.receiveShadow)&&(Be.receiveShadow=W.receiveShadow,ht.setValue(I,"receiveShadow",W.receiveShadow)),U.isMeshGouraudMaterial&&U.envMap!==null&&(fn.envMap.value=Ae,fn.flipEnvMap.value=Ae.isCubeTexture&&Ae.isRenderTargetTexture===!1?-1:1),si&&(ht.setValue(I,"toneMappingExposure",_.toneMappingExposure),Be.needsLights&&No(fn,sr),he&&U.fog===!0&&ne.refreshFogUniforms(fn,he),ne.refreshMaterialUniforms(fn,U,X,ee,le),ji.upload(I,Be.uniformsList,fn,be)),U.isShaderMaterial&&U.uniformsNeedUpdate===!0&&(ji.upload(I,Be.uniformsList,fn,be),U.uniformsNeedUpdate=!1),U.isSpriteMaterial&&ht.setValue(I,"center",W.center),ht.setValue(I,"modelViewMatrix",W.modelViewMatrix),ht.setValue(I,"normalMatrix",W.normalMatrix),ht.setValue(I,"modelMatrix",W.matrixWorld),U.isShaderMaterial||U.isRawShaderMaterial){const gt=U.uniformsGroups;for(let or=0,Oo=gt.length;or<Oo;or++)if(Re.isWebGL2){const xs=gt[or];ye.update(xs,hn),ye.bind(xs,hn)}else console.warn("THREE.WebGLRenderer: Uniform Buffer Objects can only be used with WebGL 2.")}return hn}function No(S,N){S.ambientLightColor.needsUpdate=N,S.lightProbe.needsUpdate=N,S.directionalLights.needsUpdate=N,S.directionalLightShadows.needsUpdate=N,S.pointLights.needsUpdate=N,S.pointLightShadows.needsUpdate=N,S.spotLights.needsUpdate=N,S.spotLightShadows.needsUpdate=N,S.rectAreaLights.needsUpdate=N,S.hemisphereLights.needsUpdate=N}function Fo(S){return S.isMeshLambertMaterial||S.isMeshToonMaterial||S.isMeshPhongMaterial||S.isMeshStandardMaterial||S.isShadowMaterial||S.isShaderMaterial&&S.lights===!0}this.getActiveCubeFace=function(){return A},this.getActiveMipmapLevel=function(){return R},this.getRenderTarget=function(){return P},this.setRenderTargetTextures=function(S,N,k){De.get(S.texture).__webglTexture=N,De.get(S.depthTexture).__webglTexture=k;const U=De.get(S);U.__hasExternalTextures=!0,U.__hasExternalTextures&&(U.__autoAllocateDepthBuffer=k===void 0,U.__autoAllocateDepthBuffer||xe.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),U.__useRenderToTexture=!1))},this.setRenderTargetFramebuffer=function(S,N){const k=De.get(S);k.__webglFramebuffer=N,k.__useDefaultFramebuffer=N===void 0},this.setRenderTarget=function(S,N=0,k=0){P=S,A=N,R=k;let U=!0,W=null,he=!1,Se=!1;if(S){const Ae=De.get(S);Ae.__useDefaultFramebuffer!==void 0?(Me.bindFramebuffer(I.FRAMEBUFFER,null),U=!1):Ae.__webglFramebuffer===void 0?be.setupRenderTarget(S):Ae.__hasExternalTextures&&be.rebindTextures(S,De.get(S.texture).__webglTexture,De.get(S.depthTexture).__webglTexture);const Fe=S.texture;(Fe.isData3DTexture||Fe.isDataArrayTexture||Fe.isCompressedArrayTexture)&&(Se=!0);const we=De.get(S).__webglFramebuffer;S.isWebGLCubeRenderTarget?(W=we[N],he=!0):Re.isWebGL2&&S.samples>0&&be.useMultisampledRTT(S)===!1?W=De.get(S).__webglMultisampledFramebuffer:W=we,w.copy(S.viewport),q.copy(S.scissor),ie=S.scissorTest}else w.copy(j).multiplyScalar(X).floor(),q.copy(fe).multiplyScalar(X).floor(),ie=z;if(Me.bindFramebuffer(I.FRAMEBUFFER,W)&&Re.drawBuffers&&U&&Me.drawBuffers(S,W),Me.viewport(w),Me.scissor(q),Me.setScissorTest(ie),he){const Ae=De.get(S.texture);I.framebufferTexture2D(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_CUBE_MAP_POSITIVE_X+N,Ae.__webglTexture,k)}else if(Se){const Ae=De.get(S.texture),Fe=N||0;I.framebufferTextureLayer(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0,Ae.__webglTexture,k||0,Fe)}D=-1},this.readRenderTargetPixels=function(S,N,k,U,W,he,Se){if(!(S&&S.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Te=De.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&Se!==void 0&&(Te=Te[Se]),Te){Me.bindFramebuffer(I.FRAMEBUFFER,Te);try{const Ae=S.texture,Fe=Ae.format,we=Ae.type;if(Fe!==Lt&&me.convert(Fe)!==I.getParameter(I.IMPLEMENTATION_COLOR_READ_FORMAT)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}const Ce=we===mi&&(xe.has("EXT_color_buffer_half_float")||Re.isWebGL2&&xe.has("EXT_color_buffer_float"));if(we!==an&&me.convert(we)!==I.getParameter(I.IMPLEMENTATION_COLOR_READ_TYPE)&&!(we===rn&&(Re.isWebGL2||xe.has("OES_texture_float")||xe.has("WEBGL_color_buffer_float")))&&!Ce){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}N>=0&&N<=S.width-U&&k>=0&&k<=S.height-W&&I.readPixels(N,k,U,W,me.convert(Fe),me.convert(we),he)}finally{const Ae=P!==null?De.get(P).__webglFramebuffer:null;Me.bindFramebuffer(I.FRAMEBUFFER,Ae)}}},this.copyFramebufferToTexture=function(S,N,k=0){const U=Math.pow(2,-k),W=Math.floor(N.image.width*U),he=Math.floor(N.image.height*U);be.setTexture2D(N,0),I.copyTexSubImage2D(I.TEXTURE_2D,k,0,0,S.x,S.y,W,he),Me.unbindTexture()},this.copyTextureToTexture=function(S,N,k,U=0){const W=N.image.width,he=N.image.height,Se=me.convert(k.format),Te=me.convert(k.type);be.setTexture2D(k,0),I.pixelStorei(I.UNPACK_FLIP_Y_WEBGL,k.flipY),I.pixelStorei(I.UNPACK_PREMULTIPLY_ALPHA_WEBGL,k.premultiplyAlpha),I.pixelStorei(I.UNPACK_ALIGNMENT,k.unpackAlignment),N.isDataTexture?I.texSubImage2D(I.TEXTURE_2D,U,S.x,S.y,W,he,Se,Te,N.image.data):N.isCompressedTexture?I.compressedTexSubImage2D(I.TEXTURE_2D,U,S.x,S.y,N.mipmaps[0].width,N.mipmaps[0].height,Se,N.mipmaps[0].data):I.texSubImage2D(I.TEXTURE_2D,U,S.x,S.y,Se,Te,N.image),U===0&&k.generateMipmaps&&I.generateMipmap(I.TEXTURE_2D),Me.unbindTexture()},this.copyTextureToTexture3D=function(S,N,k,U,W=0){if(_.isWebGL1Renderer){console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: can only be used with WebGL2.");return}const he=S.max.x-S.min.x+1,Se=S.max.y-S.min.y+1,Te=S.max.z-S.min.z+1,Ae=me.convert(U.format),Fe=me.convert(U.type);let we;if(U.isData3DTexture)be.setTexture3D(U,0),we=I.TEXTURE_3D;else if(U.isDataArrayTexture)be.setTexture2DArray(U,0),we=I.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}I.pixelStorei(I.UNPACK_FLIP_Y_WEBGL,U.flipY),I.pixelStorei(I.UNPACK_PREMULTIPLY_ALPHA_WEBGL,U.premultiplyAlpha),I.pixelStorei(I.UNPACK_ALIGNMENT,U.unpackAlignment);const Ce=I.getParameter(I.UNPACK_ROW_LENGTH),ke=I.getParameter(I.UNPACK_IMAGE_HEIGHT),Ze=I.getParameter(I.UNPACK_SKIP_PIXELS),At=I.getParameter(I.UNPACK_SKIP_ROWS),zt=I.getParameter(I.UNPACK_SKIP_IMAGES),je=k.isCompressedTexture?k.mipmaps[0]:k.image;I.pixelStorei(I.UNPACK_ROW_LENGTH,je.width),I.pixelStorei(I.UNPACK_IMAGE_HEIGHT,je.height),I.pixelStorei(I.UNPACK_SKIP_PIXELS,S.min.x),I.pixelStorei(I.UNPACK_SKIP_ROWS,S.min.y),I.pixelStorei(I.UNPACK_SKIP_IMAGES,S.min.z),k.isDataTexture||k.isData3DTexture?I.texSubImage3D(we,W,N.x,N.y,N.z,he,Se,Te,Ae,Fe,je.data):k.isCompressedArrayTexture?(console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: untested support for compressed srcTexture."),I.compressedTexSubImage3D(we,W,N.x,N.y,N.z,he,Se,Te,Ae,je.data)):I.texSubImage3D(we,W,N.x,N.y,N.z,he,Se,Te,Ae,Fe,je),I.pixelStorei(I.UNPACK_ROW_LENGTH,Ce),I.pixelStorei(I.UNPACK_IMAGE_HEIGHT,ke),I.pixelStorei(I.UNPACK_SKIP_PIXELS,Ze),I.pixelStorei(I.UNPACK_SKIP_ROWS,At),I.pixelStorei(I.UNPACK_SKIP_IMAGES,zt),W===0&&U.generateMipmaps&&I.generateMipmap(we),Me.unbindTexture()},this.initTexture=function(S){S.isCubeTexture?be.setTextureCube(S,0):S.isData3DTexture?be.setTexture3D(S,0):S.isDataArrayTexture||S.isCompressedArrayTexture?be.setTexture2DArray(S,0):be.setTexture2D(S,0),Me.unbindTexture()},this.resetState=function(){A=0,R=0,P=null,Me.reset(),ue.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Kt}get physicallyCorrectLights(){return console.warn("THREE.WebGLRenderer: the property .physicallyCorrectLights has been removed. Set renderer.useLegacyLights instead."),!this.useLegacyLights}set physicallyCorrectLights(e){console.warn("THREE.WebGLRenderer: the property .physicallyCorrectLights has been removed. Set renderer.useLegacyLights instead."),this.useLegacyLights=!e}get outputEncoding(){return console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace===Pe?En:no}set outputEncoding(e){console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace=e===En?Pe:Ut}}class Hd extends To{}Hd.prototype.isWebGL1Renderer=!0;class Vd extends Mt{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,t){return super.copy(e,t),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const t=super.toJSON(e);return this.fog!==null&&(t.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(t.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(t.object.backgroundIntensity=this.backgroundIntensity),t}get autoUpdate(){return console.warn("THREE.Scene: autoUpdate was renamed to matrixWorldAutoUpdate in r144."),this.matrixWorldAutoUpdate}set autoUpdate(e){console.warn("THREE.Scene: autoUpdate was renamed to matrixWorldAutoUpdate in r144."),this.matrixWorldAutoUpdate=e}}class Bt{constructor(){this.type="Curve",this.arcLengthDivisions=200}getPoint(){return console.warn("THREE.Curve: .getPoint() not implemented."),null}getPointAt(e,t){const n=this.getUtoTmapping(e);return this.getPoint(n,t)}getPoints(e=5){const t=[];for(let n=0;n<=e;n++)t.push(this.getPoint(n/e));return t}getSpacedPoints(e=5){const t=[];for(let n=0;n<=e;n++)t.push(this.getPointAt(n/e));return t}getLength(){const e=this.getLengths();return e[e.length-1]}getLengths(e=this.arcLengthDivisions){if(this.cacheArcLengths&&this.cacheArcLengths.length===e+1&&!this.needsUpdate)return this.cacheArcLengths;this.needsUpdate=!1;const t=[];let n,r=this.getPoint(0),s=0;t.push(0);for(let o=1;o<=e;o++)n=this.getPoint(o/e),s+=n.distanceTo(r),t.push(s),r=n;return this.cacheArcLengths=t,t}updateArcLengths(){this.needsUpdate=!0,this.getLengths()}getUtoTmapping(e,t){const n=this.getLengths();let r=0;const s=n.length;let o;t?o=t:o=e*n[s-1];let a=0,l=s-1,c;for(;a<=l;)if(r=Math.floor(a+(l-a)/2),c=n[r]-o,c<0)a=r+1;else if(c>0)l=r-1;else{l=r;break}if(r=l,n[r]===o)return r/(s-1);const u=n[r],f=n[r+1]-u,m=(o-u)/f;return(r+m)/(s-1)}getTangent(e,t){let r=e-1e-4,s=e+1e-4;r<0&&(r=0),s>1&&(s=1);const o=this.getPoint(r),a=this.getPoint(s),l=t||(o.isVector2?new pe:new L);return l.copy(a).sub(o).normalize(),l}getTangentAt(e,t){const n=this.getUtoTmapping(e);return this.getTangent(n,t)}computeFrenetFrames(e,t){const n=new L,r=[],s=[],o=[],a=new L,l=new st;for(let m=0;m<=e;m++){const g=m/e;r[m]=this.getTangentAt(g,new L)}s[0]=new L,o[0]=new L;let c=Number.MAX_VALUE;const u=Math.abs(r[0].x),h=Math.abs(r[0].y),f=Math.abs(r[0].z);u<=c&&(c=u,n.set(1,0,0)),h<=c&&(c=h,n.set(0,1,0)),f<=c&&n.set(0,0,1),a.crossVectors(r[0],n).normalize(),s[0].crossVectors(r[0],a),o[0].crossVectors(r[0],s[0]);for(let m=1;m<=e;m++){if(s[m]=s[m-1].clone(),o[m]=o[m-1].clone(),a.crossVectors(r[m-1],r[m]),a.length()>Number.EPSILON){a.normalize();const g=Math.acos(at(r[m-1].dot(r[m]),-1,1));s[m].applyMatrix4(l.makeRotationAxis(a,g))}o[m].crossVectors(r[m],s[m])}if(t===!0){let m=Math.acos(at(s[0].dot(s[e]),-1,1));m/=e,r[0].dot(a.crossVectors(s[0],s[e]))>0&&(m=-m);for(let g=1;g<=e;g++)s[g].applyMatrix4(l.makeRotationAxis(r[g],m*g)),o[g].crossVectors(r[g],s[g])}return{tangents:r,normals:s,binormals:o}}clone(){return new this.constructor().copy(this)}copy(e){return this.arcLengthDivisions=e.arcLengthDivisions,this}toJSON(){const e={metadata:{version:4.6,type:"Curve",generator:"Curve.toJSON"}};return e.arcLengthDivisions=this.arcLengthDivisions,e.type=this.type,e}fromJSON(e){return this.arcLengthDivisions=e.arcLengthDivisions,this}}class os extends Bt{constructor(e=0,t=0,n=1,r=1,s=0,o=Math.PI*2,a=!1,l=0){super(),this.isEllipseCurve=!0,this.type="EllipseCurve",this.aX=e,this.aY=t,this.xRadius=n,this.yRadius=r,this.aStartAngle=s,this.aEndAngle=o,this.aClockwise=a,this.aRotation=l}getPoint(e,t){const n=t||new pe,r=Math.PI*2;let s=this.aEndAngle-this.aStartAngle;const o=Math.abs(s)<Number.EPSILON;for(;s<0;)s+=r;for(;s>r;)s-=r;s<Number.EPSILON&&(o?s=0:s=r),this.aClockwise===!0&&!o&&(s===r?s=-r:s=s-r);const a=this.aStartAngle+e*s;let l=this.aX+this.xRadius*Math.cos(a),c=this.aY+this.yRadius*Math.sin(a);if(this.aRotation!==0){const u=Math.cos(this.aRotation),h=Math.sin(this.aRotation),f=l-this.aX,m=c-this.aY;l=f*u-m*h+this.aX,c=f*h+m*u+this.aY}return n.set(l,c)}copy(e){return super.copy(e),this.aX=e.aX,this.aY=e.aY,this.xRadius=e.xRadius,this.yRadius=e.yRadius,this.aStartAngle=e.aStartAngle,this.aEndAngle=e.aEndAngle,this.aClockwise=e.aClockwise,this.aRotation=e.aRotation,this}toJSON(){const e=super.toJSON();return e.aX=this.aX,e.aY=this.aY,e.xRadius=this.xRadius,e.yRadius=this.yRadius,e.aStartAngle=this.aStartAngle,e.aEndAngle=this.aEndAngle,e.aClockwise=this.aClockwise,e.aRotation=this.aRotation,e}fromJSON(e){return super.fromJSON(e),this.aX=e.aX,this.aY=e.aY,this.xRadius=e.xRadius,this.yRadius=e.yRadius,this.aStartAngle=e.aStartAngle,this.aEndAngle=e.aEndAngle,this.aClockwise=e.aClockwise,this.aRotation=e.aRotation,this}}class kd extends os{constructor(e,t,n,r,s,o){super(e,t,n,n,r,s,o),this.isArcCurve=!0,this.type="ArcCurve"}}function cs(){let i=0,e=0,t=0,n=0;function r(s,o,a,l){i=s,e=a,t=-3*s+3*o-2*a-l,n=2*s-2*o+a+l}return{initCatmullRom:function(s,o,a,l,c){r(o,a,c*(a-s),c*(l-o))},initNonuniformCatmullRom:function(s,o,a,l,c,u,h){let f=(o-s)/c-(a-s)/(c+u)+(a-o)/u,m=(a-o)/u-(l-o)/(u+h)+(l-a)/h;f*=u,m*=u,r(o,a,f,m)},calc:function(s){const o=s*s,a=o*s;return i+e*s+t*o+n*a}}}const Yi=new L,Br=new cs,zr=new cs,Gr=new cs;class Wd extends Bt{constructor(e=[],t=!1,n="centripetal",r=.5){super(),this.isCatmullRomCurve3=!0,this.type="CatmullRomCurve3",this.points=e,this.closed=t,this.curveType=n,this.tension=r}getPoint(e,t=new L){const n=t,r=this.points,s=r.length,o=(s-(this.closed?0:1))*e;let a=Math.floor(o),l=o-a;this.closed?a+=a>0?0:(Math.floor(Math.abs(a)/s)+1)*s:l===0&&a===s-1&&(a=s-2,l=1);let c,u;this.closed||a>0?c=r[(a-1)%s]:(Yi.subVectors(r[0],r[1]).add(r[0]),c=Yi);const h=r[a%s],f=r[(a+1)%s];if(this.closed||a+2<s?u=r[(a+2)%s]:(Yi.subVectors(r[s-1],r[s-2]).add(r[s-1]),u=Yi),this.curveType==="centripetal"||this.curveType==="chordal"){const m=this.curveType==="chordal"?.5:.25;let g=Math.pow(c.distanceToSquared(h),m),v=Math.pow(h.distanceToSquared(f),m),p=Math.pow(f.distanceToSquared(u),m);v<1e-4&&(v=1),g<1e-4&&(g=v),p<1e-4&&(p=v),Br.initNonuniformCatmullRom(c.x,h.x,f.x,u.x,g,v,p),zr.initNonuniformCatmullRom(c.y,h.y,f.y,u.y,g,v,p),Gr.initNonuniformCatmullRom(c.z,h.z,f.z,u.z,g,v,p)}else this.curveType==="catmullrom"&&(Br.initCatmullRom(c.x,h.x,f.x,u.x,this.tension),zr.initCatmullRom(c.y,h.y,f.y,u.y,this.tension),Gr.initCatmullRom(c.z,h.z,f.z,u.z,this.tension));return n.set(Br.calc(l),zr.calc(l),Gr.calc(l)),n}copy(e){super.copy(e),this.points=[];for(let t=0,n=e.points.length;t<n;t++){const r=e.points[t];this.points.push(r.clone())}return this.closed=e.closed,this.curveType=e.curveType,this.tension=e.tension,this}toJSON(){const e=super.toJSON();e.points=[];for(let t=0,n=this.points.length;t<n;t++){const r=this.points[t];e.points.push(r.toArray())}return e.closed=this.closed,e.curveType=this.curveType,e.tension=this.tension,e}fromJSON(e){super.fromJSON(e),this.points=[];for(let t=0,n=e.points.length;t<n;t++){const r=e.points[t];this.points.push(new L().fromArray(r))}return this.closed=e.closed,this.curveType=e.curveType,this.tension=e.tension,this}}function Fa(i,e,t,n,r){const s=(n-e)*.5,o=(r-t)*.5,a=i*i,l=i*a;return(2*t-2*n+s+o)*l+(-3*t+3*n-2*s-o)*a+s*i+t}function Xd(i,e){const t=1-i;return t*t*e}function qd(i,e){return 2*(1-i)*i*e}function Yd(i,e){return i*i*e}function fi(i,e,t,n){return Xd(i,e)+qd(i,t)+Yd(i,n)}function Zd(i,e){const t=1-i;return t*t*t*e}function Kd(i,e){const t=1-i;return 3*t*t*i*e}function jd(i,e){return 3*(1-i)*i*i*e}function Jd(i,e){return i*i*i*e}function di(i,e,t,n,r){return Zd(i,e)+Kd(i,t)+jd(i,n)+Jd(i,r)}class Ao extends Bt{constructor(e=new pe,t=new pe,n=new pe,r=new pe){super(),this.isCubicBezierCurve=!0,this.type="CubicBezierCurve",this.v0=e,this.v1=t,this.v2=n,this.v3=r}getPoint(e,t=new pe){const n=t,r=this.v0,s=this.v1,o=this.v2,a=this.v3;return n.set(di(e,r.x,s.x,o.x,a.x),di(e,r.y,s.y,o.y,a.y)),n}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this.v3.copy(e.v3),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e.v3=this.v3.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this.v3.fromArray(e.v3),this}}class $d extends Bt{constructor(e=new L,t=new L,n=new L,r=new L){super(),this.isCubicBezierCurve3=!0,this.type="CubicBezierCurve3",this.v0=e,this.v1=t,this.v2=n,this.v3=r}getPoint(e,t=new L){const n=t,r=this.v0,s=this.v1,o=this.v2,a=this.v3;return n.set(di(e,r.x,s.x,o.x,a.x),di(e,r.y,s.y,o.y,a.y),di(e,r.z,s.z,o.z,a.z)),n}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this.v3.copy(e.v3),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e.v3=this.v3.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this.v3.fromArray(e.v3),this}}class ls extends Bt{constructor(e=new pe,t=new pe){super(),this.isLineCurve=!0,this.type="LineCurve",this.v1=e,this.v2=t}getPoint(e,t=new pe){const n=t;return e===1?n.copy(this.v2):(n.copy(this.v2).sub(this.v1),n.multiplyScalar(e).add(this.v1)),n}getPointAt(e,t){return this.getPoint(e,t)}getTangent(e,t=new pe){return t.subVectors(this.v2,this.v1).normalize()}getTangentAt(e,t){return this.getTangent(e,t)}copy(e){return super.copy(e),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class Qd extends Bt{constructor(e=new L,t=new L){super(),this.isLineCurve3=!0,this.type="LineCurve3",this.v1=e,this.v2=t}getPoint(e,t=new L){const n=t;return e===1?n.copy(this.v2):(n.copy(this.v2).sub(this.v1),n.multiplyScalar(e).add(this.v1)),n}getPointAt(e,t){return this.getPoint(e,t)}getTangent(e,t=new L){return t.subVectors(this.v2,this.v1).normalize()}getTangentAt(e,t){return this.getTangent(e,t)}copy(e){return super.copy(e),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class bo extends Bt{constructor(e=new pe,t=new pe,n=new pe){super(),this.isQuadraticBezierCurve=!0,this.type="QuadraticBezierCurve",this.v0=e,this.v1=t,this.v2=n}getPoint(e,t=new pe){const n=t,r=this.v0,s=this.v1,o=this.v2;return n.set(fi(e,r.x,s.x,o.x),fi(e,r.y,s.y,o.y)),n}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class ep extends Bt{constructor(e=new L,t=new L,n=new L){super(),this.isQuadraticBezierCurve3=!0,this.type="QuadraticBezierCurve3",this.v0=e,this.v1=t,this.v2=n}getPoint(e,t=new L){const n=t,r=this.v0,s=this.v1,o=this.v2;return n.set(fi(e,r.x,s.x,o.x),fi(e,r.y,s.y,o.y),fi(e,r.z,s.z,o.z)),n}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class wo extends Bt{constructor(e=[]){super(),this.isSplineCurve=!0,this.type="SplineCurve",this.points=e}getPoint(e,t=new pe){const n=t,r=this.points,s=(r.length-1)*e,o=Math.floor(s),a=s-o,l=r[o===0?o:o-1],c=r[o],u=r[o>r.length-2?r.length-1:o+1],h=r[o>r.length-3?r.length-1:o+2];return n.set(Fa(a,l.x,c.x,u.x,h.x),Fa(a,l.y,c.y,u.y,h.y)),n}copy(e){super.copy(e),this.points=[];for(let t=0,n=e.points.length;t<n;t++){const r=e.points[t];this.points.push(r.clone())}return this}toJSON(){const e=super.toJSON();e.points=[];for(let t=0,n=this.points.length;t<n;t++){const r=this.points[t];e.points.push(r.toArray())}return e}fromJSON(e){super.fromJSON(e),this.points=[];for(let t=0,n=e.points.length;t<n;t++){const r=e.points[t];this.points.push(new pe().fromArray(r))}return this}}var tp=Object.freeze({__proto__:null,ArcCurve:kd,CatmullRomCurve3:Wd,CubicBezierCurve:Ao,CubicBezierCurve3:$d,EllipseCurve:os,LineCurve:ls,LineCurve3:Qd,QuadraticBezierCurve:bo,QuadraticBezierCurve3:ep,SplineCurve:wo});class np extends Bt{constructor(){super(),this.type="CurvePath",this.curves=[],this.autoClose=!1}add(e){this.curves.push(e)}closePath(){const e=this.curves[0].getPoint(0),t=this.curves[this.curves.length-1].getPoint(1);e.equals(t)||this.curves.push(new ls(t,e))}getPoint(e,t){const n=e*this.getLength(),r=this.getCurveLengths();let s=0;for(;s<r.length;){if(r[s]>=n){const o=r[s]-n,a=this.curves[s],l=a.getLength(),c=l===0?0:1-o/l;return a.getPointAt(c,t)}s++}return null}getLength(){const e=this.getCurveLengths();return e[e.length-1]}updateArcLengths(){this.needsUpdate=!0,this.cacheLengths=null,this.getCurveLengths()}getCurveLengths(){if(this.cacheLengths&&this.cacheLengths.length===this.curves.length)return this.cacheLengths;const e=[];let t=0;for(let n=0,r=this.curves.length;n<r;n++)t+=this.curves[n].getLength(),e.push(t);return this.cacheLengths=e,e}getSpacedPoints(e=40){const t=[];for(let n=0;n<=e;n++)t.push(this.getPoint(n/e));return this.autoClose&&t.push(t[0]),t}getPoints(e=12){const t=[];let n;for(let r=0,s=this.curves;r<s.length;r++){const o=s[r],a=o.isEllipseCurve?e*2:o.isLineCurve||o.isLineCurve3?1:o.isSplineCurve?e*o.points.length:e,l=o.getPoints(a);for(let c=0;c<l.length;c++){const u=l[c];n&&n.equals(u)||(t.push(u),n=u)}}return this.autoClose&&t.length>1&&!t[t.length-1].equals(t[0])&&t.push(t[0]),t}copy(e){super.copy(e),this.curves=[];for(let t=0,n=e.curves.length;t<n;t++){const r=e.curves[t];this.curves.push(r.clone())}return this.autoClose=e.autoClose,this}toJSON(){const e=super.toJSON();e.autoClose=this.autoClose,e.curves=[];for(let t=0,n=this.curves.length;t<n;t++){const r=this.curves[t];e.curves.push(r.toJSON())}return e}fromJSON(e){super.fromJSON(e),this.autoClose=e.autoClose,this.curves=[];for(let t=0,n=e.curves.length;t<n;t++){const r=e.curves[t];this.curves.push(new tp[r.type]().fromJSON(r))}return this}}class Qr extends np{constructor(e){super(),this.type="Path",this.currentPoint=new pe,e&&this.setFromPoints(e)}setFromPoints(e){this.moveTo(e[0].x,e[0].y);for(let t=1,n=e.length;t<n;t++)this.lineTo(e[t].x,e[t].y);return this}moveTo(e,t){return this.currentPoint.set(e,t),this}lineTo(e,t){const n=new ls(this.currentPoint.clone(),new pe(e,t));return this.curves.push(n),this.currentPoint.set(e,t),this}quadraticCurveTo(e,t,n,r){const s=new bo(this.currentPoint.clone(),new pe(e,t),new pe(n,r));return this.curves.push(s),this.currentPoint.set(n,r),this}bezierCurveTo(e,t,n,r,s,o){const a=new Ao(this.currentPoint.clone(),new pe(e,t),new pe(n,r),new pe(s,o));return this.curves.push(a),this.currentPoint.set(s,o),this}splineThru(e){const t=[this.currentPoint.clone()].concat(e),n=new wo(t);return this.curves.push(n),this.currentPoint.copy(e[e.length-1]),this}arc(e,t,n,r,s,o){const a=this.currentPoint.x,l=this.currentPoint.y;return this.absarc(e+a,t+l,n,r,s,o),this}absarc(e,t,n,r,s,o){return this.absellipse(e,t,n,n,r,s,o),this}ellipse(e,t,n,r,s,o,a,l){const c=this.currentPoint.x,u=this.currentPoint.y;return this.absellipse(e+c,t+u,n,r,s,o,a,l),this}absellipse(e,t,n,r,s,o,a,l){const c=new os(e,t,n,r,s,o,a,l);if(this.curves.length>0){const h=c.getPoint(0);h.equals(this.currentPoint)||this.lineTo(h.x,h.y)}this.curves.push(c);const u=c.getPoint(1);return this.currentPoint.copy(u),this}copy(e){return super.copy(e),this.currentPoint.copy(e.currentPoint),this}toJSON(){const e=super.toJSON();return e.currentPoint=this.currentPoint.toArray(),e}fromJSON(e){return super.fromJSON(e),this.currentPoint.fromArray(e.currentPoint),this}}class Hr extends Qr{constructor(e){super(e),this.uuid=ii(),this.type="Shape",this.holes=[]}getPointsHoles(e){const t=[];for(let n=0,r=this.holes.length;n<r;n++)t[n]=this.holes[n].getPoints(e);return t}extractPoints(e){return{shape:this.getPoints(e),holes:this.getPointsHoles(e)}}copy(e){super.copy(e),this.holes=[];for(let t=0,n=e.holes.length;t<n;t++){const r=e.holes[t];this.holes.push(r.clone())}return this}toJSON(){const e=super.toJSON();e.uuid=this.uuid,e.holes=[];for(let t=0,n=this.holes.length;t<n;t++){const r=this.holes[t];e.holes.push(r.toJSON())}return e}fromJSON(e){super.fromJSON(e),this.uuid=e.uuid,this.holes=[];for(let t=0,n=e.holes.length;t<n;t++){const r=e.holes[t];this.holes.push(new Qr().fromJSON(r))}return this}}const ip={triangulate:function(i,e,t=2){const n=e&&e.length,r=n?e[0]*t:i.length;let s=Ro(i,0,r,t,!0);const o=[];if(!s||s.next===s.prev)return o;let a,l,c,u,h,f,m;if(n&&(s=cp(i,e,s,t)),i.length>80*t){a=c=i[0],l=u=i[1];for(let g=t;g<r;g+=t)h=i[g],f=i[g+1],h<a&&(a=h),f<l&&(l=f),h>c&&(c=h),f>u&&(u=f);m=Math.max(c-a,u-l),m=m!==0?32767/m:0}return _i(s,o,t,a,l,m,0),o}};function Ro(i,e,t,n,r){let s,o;if(r===xp(i,e,t,n)>0)for(s=e;s<t;s+=n)o=Oa(s,i[s],i[s+1],o);else for(s=t-n;s>=e;s-=n)o=Oa(s,i[s],i[s+1],o);return o&&nr(o,o.next)&&(xi(o),o=o.next),o}function wn(i,e){if(!i)return i;e||(e=i);let t=i,n;do if(n=!1,!t.steiner&&(nr(t,t.next)||We(t.prev,t,t.next)===0)){if(xi(t),t=e=t.prev,t===t.next)break;n=!0}else t=t.next;while(n||t!==e);return e}function _i(i,e,t,n,r,s,o){if(!i)return;!o&&s&&dp(i,n,r,s);let a=i,l,c;for(;i.prev!==i.next;){if(l=i.prev,c=i.next,s?sp(i,n,r,s):rp(i)){e.push(l.i/t|0),e.push(i.i/t|0),e.push(c.i/t|0),xi(i),i=c.next,a=c.next;continue}if(i=c,i===a){o?o===1?(i=ap(wn(i),e,t),_i(i,e,t,n,r,s,2)):o===2&&op(i,e,t,n,r,s):_i(wn(i),e,t,n,r,s,1);break}}}function rp(i){const e=i.prev,t=i,n=i.next;if(We(e,t,n)>=0)return!1;const r=e.x,s=t.x,o=n.x,a=e.y,l=t.y,c=n.y,u=r<s?r<o?r:o:s<o?s:o,h=a<l?a<c?a:c:l<c?l:c,f=r>s?r>o?r:o:s>o?s:o,m=a>l?a>c?a:c:l>c?l:c;let g=n.next;for(;g!==e;){if(g.x>=u&&g.x<=f&&g.y>=h&&g.y<=m&&Kn(r,a,s,l,o,c,g.x,g.y)&&We(g.prev,g,g.next)>=0)return!1;g=g.next}return!0}function sp(i,e,t,n){const r=i.prev,s=i,o=i.next;if(We(r,s,o)>=0)return!1;const a=r.x,l=s.x,c=o.x,u=r.y,h=s.y,f=o.y,m=a<l?a<c?a:c:l<c?l:c,g=u<h?u<f?u:f:h<f?h:f,v=a>l?a>c?a:c:l>c?l:c,p=u>h?u>f?u:f:h>f?h:f,d=es(m,g,e,t,n),y=es(v,p,e,t,n);let _=i.prevZ,T=i.nextZ;for(;_&&_.z>=d&&T&&T.z<=y;){if(_.x>=m&&_.x<=v&&_.y>=g&&_.y<=p&&_!==r&&_!==o&&Kn(a,u,l,h,c,f,_.x,_.y)&&We(_.prev,_,_.next)>=0||(_=_.prevZ,T.x>=m&&T.x<=v&&T.y>=g&&T.y<=p&&T!==r&&T!==o&&Kn(a,u,l,h,c,f,T.x,T.y)&&We(T.prev,T,T.next)>=0))return!1;T=T.nextZ}for(;_&&_.z>=d;){if(_.x>=m&&_.x<=v&&_.y>=g&&_.y<=p&&_!==r&&_!==o&&Kn(a,u,l,h,c,f,_.x,_.y)&&We(_.prev,_,_.next)>=0)return!1;_=_.prevZ}for(;T&&T.z<=y;){if(T.x>=m&&T.x<=v&&T.y>=g&&T.y<=p&&T!==r&&T!==o&&Kn(a,u,l,h,c,f,T.x,T.y)&&We(T.prev,T,T.next)>=0)return!1;T=T.nextZ}return!0}function ap(i,e,t){let n=i;do{const r=n.prev,s=n.next.next;!nr(r,s)&&Co(r,n,n.next,s)&&vi(r,s)&&vi(s,r)&&(e.push(r.i/t|0),e.push(n.i/t|0),e.push(s.i/t|0),xi(n),xi(n.next),n=i=s),n=n.next}while(n!==i);return wn(n)}function op(i,e,t,n,r,s){let o=i;do{let a=o.next.next;for(;a!==o.prev;){if(o.i!==a.i&&gp(o,a)){let l=Po(o,a);o=wn(o,o.next),l=wn(l,l.next),_i(o,e,t,n,r,s,0),_i(l,e,t,n,r,s,0);return}a=a.next}o=o.next}while(o!==i)}function cp(i,e,t,n){const r=[];let s,o,a,l,c;for(s=0,o=e.length;s<o;s++)a=e[s]*n,l=s<o-1?e[s+1]*n:i.length,c=Ro(i,a,l,n,!1),c===c.next&&(c.steiner=!0),r.push(mp(c));for(r.sort(lp),s=0;s<r.length;s++)t=up(r[s],t);return t}function lp(i,e){return i.x-e.x}function up(i,e){const t=hp(i,e);if(!t)return e;const n=Po(t,i);return wn(n,n.next),wn(t,t.next)}function hp(i,e){let t=e,n=-1/0,r;const s=i.x,o=i.y;do{if(o<=t.y&&o>=t.next.y&&t.next.y!==t.y){const f=t.x+(o-t.y)*(t.next.x-t.x)/(t.next.y-t.y);if(f<=s&&f>n&&(n=f,r=t.x<t.next.x?t:t.next,f===s))return r}t=t.next}while(t!==e);if(!r)return null;const a=r,l=r.x,c=r.y;let u=1/0,h;t=r;do s>=t.x&&t.x>=l&&s!==t.x&&Kn(o<c?s:n,o,l,c,o<c?n:s,o,t.x,t.y)&&(h=Math.abs(o-t.y)/(s-t.x),vi(t,i)&&(h<u||h===u&&(t.x>r.x||t.x===r.x&&fp(r,t)))&&(r=t,u=h)),t=t.next;while(t!==a);return r}function fp(i,e){return We(i.prev,i,e.prev)<0&&We(e.next,i,i.next)<0}function dp(i,e,t,n){let r=i;do r.z===0&&(r.z=es(r.x,r.y,e,t,n)),r.prevZ=r.prev,r.nextZ=r.next,r=r.next;while(r!==i);r.prevZ.nextZ=null,r.prevZ=null,pp(r)}function pp(i){let e,t,n,r,s,o,a,l,c=1;do{for(t=i,i=null,s=null,o=0;t;){for(o++,n=t,a=0,e=0;e<c&&(a++,n=n.nextZ,!!n);e++);for(l=c;a>0||l>0&&n;)a!==0&&(l===0||!n||t.z<=n.z)?(r=t,t=t.nextZ,a--):(r=n,n=n.nextZ,l--),s?s.nextZ=r:i=r,r.prevZ=s,s=r;t=n}s.nextZ=null,c*=2}while(o>1);return i}function es(i,e,t,n,r){return i=(i-t)*r|0,e=(e-n)*r|0,i=(i|i<<8)&16711935,i=(i|i<<4)&252645135,i=(i|i<<2)&858993459,i=(i|i<<1)&1431655765,e=(e|e<<8)&16711935,e=(e|e<<4)&252645135,e=(e|e<<2)&858993459,e=(e|e<<1)&1431655765,i|e<<1}function mp(i){let e=i,t=i;do(e.x<t.x||e.x===t.x&&e.y<t.y)&&(t=e),e=e.next;while(e!==i);return t}function Kn(i,e,t,n,r,s,o,a){return(r-o)*(e-a)>=(i-o)*(s-a)&&(i-o)*(n-a)>=(t-o)*(e-a)&&(t-o)*(s-a)>=(r-o)*(n-a)}function gp(i,e){return i.next.i!==e.i&&i.prev.i!==e.i&&!_p(i,e)&&(vi(i,e)&&vi(e,i)&&vp(i,e)&&(We(i.prev,i,e.prev)||We(i,e.prev,e))||nr(i,e)&&We(i.prev,i,i.next)>0&&We(e.prev,e,e.next)>0)}function We(i,e,t){return(e.y-i.y)*(t.x-e.x)-(e.x-i.x)*(t.y-e.y)}function nr(i,e){return i.x===e.x&&i.y===e.y}function Co(i,e,t,n){const r=Ki(We(i,e,t)),s=Ki(We(i,e,n)),o=Ki(We(t,n,i)),a=Ki(We(t,n,e));return!!(r!==s&&o!==a||r===0&&Zi(i,t,e)||s===0&&Zi(i,n,e)||o===0&&Zi(t,i,n)||a===0&&Zi(t,e,n))}function Zi(i,e,t){return e.x<=Math.max(i.x,t.x)&&e.x>=Math.min(i.x,t.x)&&e.y<=Math.max(i.y,t.y)&&e.y>=Math.min(i.y,t.y)}function Ki(i){return i>0?1:i<0?-1:0}function _p(i,e){let t=i;do{if(t.i!==i.i&&t.next.i!==i.i&&t.i!==e.i&&t.next.i!==e.i&&Co(t,t.next,i,e))return!0;t=t.next}while(t!==i);return!1}function vi(i,e){return We(i.prev,i,i.next)<0?We(i,e,i.next)>=0&&We(i,i.prev,e)>=0:We(i,e,i.prev)<0||We(i,i.next,e)<0}function vp(i,e){let t=i,n=!1;const r=(i.x+e.x)/2,s=(i.y+e.y)/2;do t.y>s!=t.next.y>s&&t.next.y!==t.y&&r<(t.next.x-t.x)*(s-t.y)/(t.next.y-t.y)+t.x&&(n=!n),t=t.next;while(t!==i);return n}function Po(i,e){const t=new ts(i.i,i.x,i.y),n=new ts(e.i,e.x,e.y),r=i.next,s=e.prev;return i.next=e,e.prev=i,t.next=r,r.prev=t,n.next=t,t.prev=n,s.next=n,n.prev=s,n}function Oa(i,e,t,n){const r=new ts(i,e,t);return n?(r.next=n.next,r.prev=n,n.next.prev=r,n.next=r):(r.prev=r,r.next=r),r}function xi(i){i.next.prev=i.prev,i.prev.next=i.next,i.prevZ&&(i.prevZ.nextZ=i.nextZ),i.nextZ&&(i.nextZ.prevZ=i.prevZ)}function ts(i,e,t){this.i=i,this.x=e,this.y=t,this.prev=null,this.next=null,this.z=0,this.prevZ=null,this.nextZ=null,this.steiner=!1}function xp(i,e,t,n){let r=0;for(let s=e,o=t-n;s<t;s+=n)r+=(i[o]-i[s])*(i[s+1]+i[o+1]),o=s;return r}class us{static area(e){const t=e.length;let n=0;for(let r=t-1,s=0;s<t;r=s++)n+=e[r].x*e[s].y-e[s].x*e[r].y;return n*.5}static isClockWise(e){return us.area(e)<0}static triangulateShape(e,t){const n=[],r=[],s=[];Ba(e),za(n,e);let o=e.length;t.forEach(Ba);for(let l=0;l<t.length;l++)r.push(o),o+=t[l].length,za(n,t[l]);const a=ip.triangulate(n,r);for(let l=0;l<a.length;l+=3)s.push(a.slice(l,l+3));return s}}function Ba(i){const e=i.length;e>2&&i[e-1].equals(i[0])&&i.pop()}function za(i,e){for(let t=0;t<e.length;t++)i.push(e[t].x),i.push(e[t].y)}class hs extends ln{constructor(e=1,t=.4,n=12,r=48,s=Math.PI*2){super(),this.type="TorusGeometry",this.parameters={radius:e,tube:t,radialSegments:n,tubularSegments:r,arc:s},n=Math.floor(n),r=Math.floor(r);const o=[],a=[],l=[],c=[],u=new L,h=new L,f=new L;for(let m=0;m<=n;m++)for(let g=0;g<=r;g++){const v=g/r*s,p=m/n*Math.PI*2;h.x=(e+t*Math.cos(p))*Math.cos(v),h.y=(e+t*Math.cos(p))*Math.sin(v),h.z=t*Math.sin(p),a.push(h.x,h.y,h.z),u.x=e*Math.cos(v),u.y=e*Math.sin(v),f.subVectors(h,u).normalize(),l.push(f.x,f.y,f.z),c.push(g/r),c.push(m/n)}for(let m=1;m<=n;m++)for(let g=1;g<=r;g++){const v=(r+1)*m+g-1,p=(r+1)*(m-1)+g-1,d=(r+1)*(m-1)+g,y=(r+1)*m+g;o.push(v,p,y),o.push(p,d,y)}this.setIndex(o),this.setAttribute("position",new Ot(a,3)),this.setAttribute("normal",new Ot(l,3)),this.setAttribute("uv",new Ot(c,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new hs(e.radius,e.tube,e.radialSegments,e.tubularSegments,e.arc)}}class Mp extends Si{constructor(e){super(),this.isMeshMatcapMaterial=!0,this.defines={MATCAP:""},this.type="MeshMatcapMaterial",this.color=new Ve(16777215),this.matcap=null,this.map=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=io,this.normalScale=new pe(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.alphaMap=null,this.flatShading=!1,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.defines={MATCAP:""},this.color.copy(e.color),this.matcap=e.matcap,this.map=e.map,this.bumpMap=e.bumpMap,this.bumpScale=e.bumpScale,this.normalMap=e.normalMap,this.normalMapType=e.normalMapType,this.normalScale.copy(e.normalScale),this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.alphaMap=e.alphaMap,this.flatShading=e.flatShading,this.fog=e.fog,this}}const $i={enabled:!1,files:{},add:function(i,e){this.enabled!==!1&&(this.files[i]=e)},get:function(i){if(this.enabled!==!1)return this.files[i]},remove:function(i){delete this.files[i]},clear:function(){this.files={}}};class Sp{constructor(e,t,n){const r=this;let s=!1,o=0,a=0,l;const c=[];this.onStart=void 0,this.onLoad=e,this.onProgress=t,this.onError=n,this.itemStart=function(u){a++,s===!1&&r.onStart!==void 0&&r.onStart(u,o,a),s=!0},this.itemEnd=function(u){o++,r.onProgress!==void 0&&r.onProgress(u,o,a),o===a&&(s=!1,r.onLoad!==void 0&&r.onLoad())},this.itemError=function(u){r.onError!==void 0&&r.onError(u)},this.resolveURL=function(u){return l?l(u):u},this.setURLModifier=function(u){return l=u,this},this.addHandler=function(u,h){return c.push(u,h),this},this.removeHandler=function(u){const h=c.indexOf(u);return h!==-1&&c.splice(h,2),this},this.getHandler=function(u){for(let h=0,f=c.length;h<f;h+=2){const m=c[h],g=c[h+1];if(m.global&&(m.lastIndex=0),m.test(u))return g}return null}}}const Ep=new Sp;class ir{constructor(e){this.manager=e!==void 0?e:Ep,this.crossOrigin="anonymous",this.withCredentials=!1,this.path="",this.resourcePath="",this.requestHeader={}}load(){}loadAsync(e,t){const n=this;return new Promise(function(r,s){n.load(e,r,t,s)})}parse(){}setCrossOrigin(e){return this.crossOrigin=e,this}setWithCredentials(e){return this.withCredentials=e,this}setPath(e){return this.path=e,this}setResourcePath(e){return this.resourcePath=e,this}setRequestHeader(e){return this.requestHeader=e,this}}const qt={};class yp extends Error{constructor(e,t){super(e),this.response=t}}class Tp extends ir{constructor(e){super(e)}load(e,t,n,r){e===void 0&&(e=""),this.path!==void 0&&(e=this.path+e),e=this.manager.resolveURL(e);const s=$i.get(e);if(s!==void 0)return this.manager.itemStart(e),setTimeout(()=>{t&&t(s),this.manager.itemEnd(e)},0),s;if(qt[e]!==void 0){qt[e].push({onLoad:t,onProgress:n,onError:r});return}qt[e]=[],qt[e].push({onLoad:t,onProgress:n,onError:r});const o=new Request(e,{headers:new Headers(this.requestHeader),credentials:this.withCredentials?"include":"same-origin"}),a=this.mimeType,l=this.responseType;fetch(o).then(c=>{if(c.status===200||c.status===0){if(c.status===0&&console.warn("THREE.FileLoader: HTTP Status 0 received."),typeof ReadableStream>"u"||c.body===void 0||c.body.getReader===void 0)return c;const u=qt[e],h=c.body.getReader(),f=c.headers.get("Content-Length")||c.headers.get("X-File-Size"),m=f?parseInt(f):0,g=m!==0;let v=0;const p=new ReadableStream({start(d){y();function y(){h.read().then(({done:_,value:T})=>{if(_)d.close();else{v+=T.byteLength;const A=new ProgressEvent("progress",{lengthComputable:g,loaded:v,total:m});for(let R=0,P=u.length;R<P;R++){const D=u[R];D.onProgress&&D.onProgress(A)}d.enqueue(T),y()}})}}});return new Response(p)}else throw new yp(`fetch for "${c.url}" responded with ${c.status}: ${c.statusText}`,c)}).then(c=>{switch(l){case"arraybuffer":return c.arrayBuffer();case"blob":return c.blob();case"document":return c.text().then(u=>new DOMParser().parseFromString(u,a));case"json":return c.json();default:if(a===void 0)return c.text();{const h=/charset="?([^;"\s]*)"?/i.exec(a),f=h&&h[1]?h[1].toLowerCase():void 0,m=new TextDecoder(f);return c.arrayBuffer().then(g=>m.decode(g))}}}).then(c=>{$i.add(e,c);const u=qt[e];delete qt[e];for(let h=0,f=u.length;h<f;h++){const m=u[h];m.onLoad&&m.onLoad(c)}}).catch(c=>{const u=qt[e];if(u===void 0)throw this.manager.itemError(e),c;delete qt[e];for(let h=0,f=u.length;h<f;h++){const m=u[h];m.onError&&m.onError(c)}this.manager.itemError(e)}).finally(()=>{this.manager.itemEnd(e)}),this.manager.itemStart(e)}setResponseType(e){return this.responseType=e,this}setMimeType(e){return this.mimeType=e,this}}class Ap extends ir{constructor(e){super(e)}load(e,t,n,r){this.path!==void 0&&(e=this.path+e),e=this.manager.resolveURL(e);const s=this,o=$i.get(e);if(o!==void 0)return s.manager.itemStart(e),setTimeout(function(){t&&t(o),s.manager.itemEnd(e)},0),o;const a=gi("img");function l(){u(),$i.add(e,this),t&&t(this),s.manager.itemEnd(e)}function c(h){u(),r&&r(h),s.manager.itemError(e),s.manager.itemEnd(e)}function u(){a.removeEventListener("load",l,!1),a.removeEventListener("error",c,!1)}return a.addEventListener("load",l,!1),a.addEventListener("error",c,!1),e.slice(0,5)!=="data:"&&this.crossOrigin!==void 0&&(a.crossOrigin=this.crossOrigin),s.manager.itemStart(e),a.src=e,a}}class bp extends ir{constructor(e){super(e)}load(e,t,n,r){const s=new mt,o=new Ap(this.manager);return o.setCrossOrigin(this.crossOrigin),o.setPath(this.path),o.load(e,function(a){s.image=a,s.needsUpdate=!0,t!==void 0&&t(s)},n,r),s}}class wp{constructor(e=!0){this.autoStart=e,this.startTime=0,this.oldTime=0,this.elapsedTime=0,this.running=!1}start(){this.startTime=Ga(),this.oldTime=this.startTime,this.elapsedTime=0,this.running=!0}stop(){this.getElapsedTime(),this.running=!1,this.autoStart=!1}getElapsedTime(){return this.getDelta(),this.elapsedTime}getDelta(){let e=0;if(this.autoStart&&!this.running)return this.start(),0;if(this.running){const t=Ga();e=(t-this.oldTime)/1e3,this.oldTime=t,this.elapsedTime+=e}return e}}function Ga(){return(typeof performance>"u"?Date:performance).now()}class Ha{constructor(e=1,t=0,n=0){return this.radius=e,this.phi=t,this.theta=n,this}set(e,t,n){return this.radius=e,this.phi=t,this.theta=n,this}copy(e){return this.radius=e.radius,this.phi=e.phi,this.theta=e.theta,this}makeSafe(){return this.phi=Math.max(1e-6,Math.min(Math.PI-1e-6,this.phi)),this}setFromVector3(e){return this.setFromCartesianCoords(e.x,e.y,e.z)}setFromCartesianCoords(e,t,n){return this.radius=Math.sqrt(e*e+t*t+n*n),this.radius===0?(this.theta=0,this.phi=0):(this.theta=Math.atan2(e,n),this.phi=Math.acos(at(t/this.radius,-1,1))),this}clone(){return new this.constructor().copy(this)}}class Rp{constructor(){this.type="ShapePath",this.color=new Ve,this.subPaths=[],this.currentPath=null}moveTo(e,t){return this.currentPath=new Qr,this.subPaths.push(this.currentPath),this.currentPath.moveTo(e,t),this}lineTo(e,t){return this.currentPath.lineTo(e,t),this}quadraticCurveTo(e,t,n,r){return this.currentPath.quadraticCurveTo(e,t,n,r),this}bezierCurveTo(e,t,n,r,s,o){return this.currentPath.bezierCurveTo(e,t,n,r,s,o),this}splineThru(e){return this.currentPath.splineThru(e),this}toShapes(e){function t(d){const y=[];for(let _=0,T=d.length;_<T;_++){const A=d[_],R=new Hr;R.curves=A.curves,y.push(R)}return y}function n(d,y){const _=y.length;let T=!1;for(let A=_-1,R=0;R<_;A=R++){let P=y[A],D=y[R],M=D.x-P.x,w=D.y-P.y;if(Math.abs(w)>Number.EPSILON){if(w<0&&(P=y[R],M=-M,D=y[A],w=-w),d.y<P.y||d.y>D.y)continue;if(d.y===P.y){if(d.x===P.x)return!0}else{const q=w*(d.x-P.x)-M*(d.y-P.y);if(q===0)return!0;if(q<0)continue;T=!T}}else{if(d.y!==P.y)continue;if(D.x<=d.x&&d.x<=P.x||P.x<=d.x&&d.x<=D.x)return!0}}return T}const r=us.isClockWise,s=this.subPaths;if(s.length===0)return[];let o,a,l;const c=[];if(s.length===1)return a=s[0],l=new Hr,l.curves=a.curves,c.push(l),c;let u=!r(s[0].getPoints());u=e?!u:u;const h=[],f=[];let m=[],g=0,v;f[g]=void 0,m[g]=[];for(let d=0,y=s.length;d<y;d++)a=s[d],v=a.getPoints(),o=r(v),o=e?!o:o,o?(!u&&f[g]&&g++,f[g]={s:new Hr,p:v},f[g].s.curves=a.curves,u&&g++,m[g]=[]):m[g].push({h:a,p:v[0]});if(!f[0])return t(s);if(f.length>1){let d=!1,y=0;for(let _=0,T=f.length;_<T;_++)h[_]=[];for(let _=0,T=f.length;_<T;_++){const A=m[_];for(let R=0;R<A.length;R++){const P=A[R];let D=!0;for(let M=0;M<f.length;M++)n(P.p,f[M].p)&&(_!==M&&y++,D?(D=!1,h[M].push(P)):d=!0);D&&h[_].push(P)}}y>0&&d===!1&&(m=h)}let p;for(let d=0,y=f.length;d<y;d++){l=f[d].s,c.push(l),p=m[d];for(let _=0,T=p.length;_<T;_++)l.holes.push(p[_].h)}return c}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:ns}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=ns);const Va={type:"change"},Vr={type:"start"},ka={type:"end"};class Cp extends Rn{constructor(e,t){super(),this.object=e,this.domElement=t,this.domElement.style.touchAction="none",this.enabled=!0,this.target=new L,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:Cn.ROTATE,MIDDLE:Cn.DOLLY,RIGHT:Cn.PAN},this.touches={ONE:Pn.ROTATE,TWO:Pn.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this.getPolarAngle=function(){return a.phi},this.getAzimuthalAngle=function(){return a.theta},this.getDistance=function(){return this.object.position.distanceTo(this.target)},this.listenToKeyEvents=function(b){b.addEventListener("keydown",Ge),this._domElementKeyEvents=b},this.stopListenToKeyEvents=function(){this._domElementKeyEvents.removeEventListener("keydown",Ge),this._domElementKeyEvents=null},this.saveState=function(){n.target0.copy(n.target),n.position0.copy(n.object.position),n.zoom0=n.object.zoom},this.reset=function(){n.target.copy(n.target0),n.object.position.copy(n.position0),n.object.zoom=n.zoom0,n.object.updateProjectionMatrix(),n.dispatchEvent(Va),n.update(),s=r.NONE},this.update=function(){const b=new L,Z=new An().setFromUnitVectors(e.up,new L(0,1,0)),Q=Z.clone().invert(),B=new L,de=new An,_e=new L,ge=2*Math.PI;return function(){const ue=n.object.position;b.copy(ue).sub(n.target),b.applyQuaternion(Z),a.setFromVector3(b),n.autoRotate&&s===r.NONE&&M(P()),n.enableDamping?(a.theta+=l.theta*n.dampingFactor,a.phi+=l.phi*n.dampingFactor):(a.theta+=l.theta,a.phi+=l.phi);let ye=n.minAzimuthAngle,Oe=n.maxAzimuthAngle;return isFinite(ye)&&isFinite(Oe)&&(ye<-Math.PI?ye+=ge:ye>Math.PI&&(ye-=ge),Oe<-Math.PI?Oe+=ge:Oe>Math.PI&&(Oe-=ge),ye<=Oe?a.theta=Math.max(ye,Math.min(Oe,a.theta)):a.theta=a.theta>(ye+Oe)/2?Math.max(ye,a.theta):Math.min(Oe,a.theta)),a.phi=Math.max(n.minPolarAngle,Math.min(n.maxPolarAngle,a.phi)),a.makeSafe(),a.radius*=c,a.radius=Math.max(n.minDistance,Math.min(n.maxDistance,a.radius)),n.enableDamping===!0?n.target.addScaledVector(u,n.dampingFactor):n.target.add(u),b.setFromSpherical(a),b.applyQuaternion(Q),ue.copy(n.target).add(b),n.object.lookAt(n.target),n.enableDamping===!0?(l.theta*=1-n.dampingFactor,l.phi*=1-n.dampingFactor,u.multiplyScalar(1-n.dampingFactor)):(l.set(0,0,0),u.set(0,0,0)),c=1,h||B.distanceToSquared(n.object.position)>o||8*(1-de.dot(n.object.quaternion))>o||_e.distanceToSquared(n.target)>0?(n.dispatchEvent(Va),B.copy(n.object.position),de.copy(n.object.quaternion),_e.copy(n.target),h=!1,!0):!1}}(),this.dispose=function(){n.domElement.removeEventListener("contextmenu",E),n.domElement.removeEventListener("pointerdown",xe),n.domElement.removeEventListener("pointercancel",Me),n.domElement.removeEventListener("wheel",be),n.domElement.removeEventListener("pointermove",Re),n.domElement.removeEventListener("pointerup",Me),n._domElementKeyEvents!==null&&(n._domElementKeyEvents.removeEventListener("keydown",Ge),n._domElementKeyEvents=null)};const n=this,r={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6};let s=r.NONE;const o=1e-6,a=new Ha,l=new Ha;let c=1;const u=new L;let h=!1;const f=new pe,m=new pe,g=new pe,v=new pe,p=new pe,d=new pe,y=new pe,_=new pe,T=new pe,A=[],R={};function P(){return 2*Math.PI/60/60*n.autoRotateSpeed}function D(){return Math.pow(.95,n.zoomSpeed)}function M(b){l.theta-=b}function w(b){l.phi-=b}const q=function(){const b=new L;return function(Q,B){b.setFromMatrixColumn(B,0),b.multiplyScalar(-Q),u.add(b)}}(),ie=function(){const b=new L;return function(Q,B){n.screenSpacePanning===!0?b.setFromMatrixColumn(B,1):(b.setFromMatrixColumn(B,0),b.crossVectors(n.object.up,b)),b.multiplyScalar(Q),u.add(b)}}(),F=function(){const b=new L;return function(Q,B){const de=n.domElement;if(n.object.isPerspectiveCamera){const _e=n.object.position;b.copy(_e).sub(n.target);let ge=b.length();ge*=Math.tan(n.object.fov/2*Math.PI/180),q(2*Q*ge/de.clientHeight,n.object.matrix),ie(2*B*ge/de.clientHeight,n.object.matrix)}else n.object.isOrthographicCamera?(q(Q*(n.object.right-n.object.left)/n.object.zoom/de.clientWidth,n.object.matrix),ie(B*(n.object.top-n.object.bottom)/n.object.zoom/de.clientHeight,n.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),n.enablePan=!1)}}();function G(b){n.object.isPerspectiveCamera?c/=b:n.object.isOrthographicCamera?(n.object.zoom=Math.max(n.minZoom,Math.min(n.maxZoom,n.object.zoom*b)),n.object.updateProjectionMatrix(),h=!0):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),n.enableZoom=!1)}function H(b){n.object.isPerspectiveCamera?c*=b:n.object.isOrthographicCamera?(n.object.zoom=Math.max(n.minZoom,Math.min(n.maxZoom,n.object.zoom/b)),n.object.updateProjectionMatrix(),h=!0):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),n.enableZoom=!1)}function ee(b){f.set(b.clientX,b.clientY)}function X(b){y.set(b.clientX,b.clientY)}function Y(b){v.set(b.clientX,b.clientY)}function K(b){m.set(b.clientX,b.clientY),g.subVectors(m,f).multiplyScalar(n.rotateSpeed);const Z=n.domElement;M(2*Math.PI*g.x/Z.clientHeight),w(2*Math.PI*g.y/Z.clientHeight),f.copy(m),n.update()}function j(b){_.set(b.clientX,b.clientY),T.subVectors(_,y),T.y>0?G(D()):T.y<0&&H(D()),y.copy(_),n.update()}function fe(b){p.set(b.clientX,b.clientY),d.subVectors(p,v).multiplyScalar(n.panSpeed),F(d.x,d.y),v.copy(p),n.update()}function z(b){b.deltaY<0?H(D()):b.deltaY>0&&G(D()),n.update()}function J(b){let Z=!1;switch(b.code){case n.keys.UP:b.ctrlKey||b.metaKey||b.shiftKey?w(2*Math.PI*n.rotateSpeed/n.domElement.clientHeight):F(0,n.keyPanSpeed),Z=!0;break;case n.keys.BOTTOM:b.ctrlKey||b.metaKey||b.shiftKey?w(-2*Math.PI*n.rotateSpeed/n.domElement.clientHeight):F(0,-n.keyPanSpeed),Z=!0;break;case n.keys.LEFT:b.ctrlKey||b.metaKey||b.shiftKey?M(2*Math.PI*n.rotateSpeed/n.domElement.clientHeight):F(n.keyPanSpeed,0),Z=!0;break;case n.keys.RIGHT:b.ctrlKey||b.metaKey||b.shiftKey?M(-2*Math.PI*n.rotateSpeed/n.domElement.clientHeight):F(-n.keyPanSpeed,0),Z=!0;break}Z&&(b.preventDefault(),n.update())}function $(){if(A.length===1)f.set(A[0].pageX,A[0].pageY);else{const b=.5*(A[0].pageX+A[1].pageX),Z=.5*(A[0].pageY+A[1].pageY);f.set(b,Z)}}function ce(){if(A.length===1)v.set(A[0].pageX,A[0].pageY);else{const b=.5*(A[0].pageX+A[1].pageX),Z=.5*(A[0].pageY+A[1].pageY);v.set(b,Z)}}function le(){const b=A[0].pageX-A[1].pageX,Z=A[0].pageY-A[1].pageY,Q=Math.sqrt(b*b+Z*Z);y.set(0,Q)}function ve(){n.enableZoom&&le(),n.enablePan&&ce()}function Le(){n.enableZoom&&le(),n.enableRotate&&$()}function Ee(b){if(A.length==1)m.set(b.pageX,b.pageY);else{const Q=te(b),B=.5*(b.pageX+Q.x),de=.5*(b.pageY+Q.y);m.set(B,de)}g.subVectors(m,f).multiplyScalar(n.rotateSpeed);const Z=n.domElement;M(2*Math.PI*g.x/Z.clientHeight),w(2*Math.PI*g.y/Z.clientHeight),f.copy(m)}function Ye(b){if(A.length===1)p.set(b.pageX,b.pageY);else{const Z=te(b),Q=.5*(b.pageX+Z.x),B=.5*(b.pageY+Z.y);p.set(Q,B)}d.subVectors(p,v).multiplyScalar(n.panSpeed),F(d.x,d.y),v.copy(p)}function Ne(b){const Z=te(b),Q=b.pageX-Z.x,B=b.pageY-Z.y,de=Math.sqrt(Q*Q+B*B);_.set(0,de),T.set(0,Math.pow(_.y/y.y,n.zoomSpeed)),G(T.y),y.copy(_)}function I(b){n.enableZoom&&Ne(b),n.enablePan&&Ye(b)}function $e(b){n.enableZoom&&Ne(b),n.enableRotate&&Ee(b)}function xe(b){n.enabled!==!1&&(A.length===0&&(n.domElement.setPointerCapture(b.pointerId),n.domElement.addEventListener("pointermove",Re),n.domElement.addEventListener("pointerup",Me)),x(b),b.pointerType==="touch"?Qe(b):He(b))}function Re(b){n.enabled!==!1&&(b.pointerType==="touch"?nt(b):De(b))}function Me(b){V(b),A.length===0&&(n.domElement.releasePointerCapture(b.pointerId),n.domElement.removeEventListener("pointermove",Re),n.domElement.removeEventListener("pointerup",Me)),n.dispatchEvent(ka),s=r.NONE}function He(b){let Z;switch(b.button){case 0:Z=n.mouseButtons.LEFT;break;case 1:Z=n.mouseButtons.MIDDLE;break;case 2:Z=n.mouseButtons.RIGHT;break;default:Z=-1}switch(Z){case Cn.DOLLY:if(n.enableZoom===!1)return;X(b),s=r.DOLLY;break;case Cn.ROTATE:if(b.ctrlKey||b.metaKey||b.shiftKey){if(n.enablePan===!1)return;Y(b),s=r.PAN}else{if(n.enableRotate===!1)return;ee(b),s=r.ROTATE}break;case Cn.PAN:if(b.ctrlKey||b.metaKey||b.shiftKey){if(n.enableRotate===!1)return;ee(b),s=r.ROTATE}else{if(n.enablePan===!1)return;Y(b),s=r.PAN}break;default:s=r.NONE}s!==r.NONE&&n.dispatchEvent(Vr)}function De(b){switch(s){case r.ROTATE:if(n.enableRotate===!1)return;K(b);break;case r.DOLLY:if(n.enableZoom===!1)return;j(b);break;case r.PAN:if(n.enablePan===!1)return;fe(b);break}}function be(b){n.enabled===!1||n.enableZoom===!1||s!==r.NONE||(b.preventDefault(),n.dispatchEvent(Vr),z(b),n.dispatchEvent(ka))}function Ge(b){n.enabled===!1||n.enablePan===!1||J(b)}function Qe(b){switch(ne(b),A.length){case 1:switch(n.touches.ONE){case Pn.ROTATE:if(n.enableRotate===!1)return;$(),s=r.TOUCH_ROTATE;break;case Pn.PAN:if(n.enablePan===!1)return;ce(),s=r.TOUCH_PAN;break;default:s=r.NONE}break;case 2:switch(n.touches.TWO){case Pn.DOLLY_PAN:if(n.enableZoom===!1&&n.enablePan===!1)return;ve(),s=r.TOUCH_DOLLY_PAN;break;case Pn.DOLLY_ROTATE:if(n.enableZoom===!1&&n.enableRotate===!1)return;Le(),s=r.TOUCH_DOLLY_ROTATE;break;default:s=r.NONE}break;default:s=r.NONE}s!==r.NONE&&n.dispatchEvent(Vr)}function nt(b){switch(ne(b),s){case r.TOUCH_ROTATE:if(n.enableRotate===!1)return;Ee(b),n.update();break;case r.TOUCH_PAN:if(n.enablePan===!1)return;Ye(b),n.update();break;case r.TOUCH_DOLLY_PAN:if(n.enableZoom===!1&&n.enablePan===!1)return;I(b),n.update();break;case r.TOUCH_DOLLY_ROTATE:if(n.enableZoom===!1&&n.enableRotate===!1)return;$e(b),n.update();break;default:s=r.NONE}}function E(b){n.enabled!==!1&&b.preventDefault()}function x(b){A.push(b)}function V(b){delete R[b.pointerId];for(let Z=0;Z<A.length;Z++)if(A[Z].pointerId==b.pointerId){A.splice(Z,1);return}}function ne(b){let Z=R[b.pointerId];Z===void 0&&(Z=new pe,R[b.pointerId]=Z),Z.set(b.pageX,b.pageY)}function te(b){const Z=b.pointerId===A[0].pointerId?A[1]:A[0];return R[Z.pointerId]}n.domElement.addEventListener("contextmenu",E),n.domElement.addEventListener("pointerdown",xe),n.domElement.addEventListener("pointercancel",Me),n.domElement.addEventListener("wheel",be,{passive:!1}),this.update()}}class Pp extends ir{constructor(e){super(e)}load(e,t,n,r){const s=this,o=new Tp(this.manager);o.setPath(this.path),o.setRequestHeader(this.requestHeader),o.setWithCredentials(this.withCredentials),o.load(e,function(a){const l=s.parse(JSON.parse(a));t&&t(l)},n,r)}parse(e){return new Lp(e)}}class Lp{constructor(e){this.isFont=!0,this.type="Font",this.data=e}generateShapes(e,t=100){const n=[],r=Up(e,t,this.data);for(let s=0,o=r.length;s<o;s++)n.push(...r[s].toShapes());return n}}function Up(i,e,t){const n=Array.from(i),r=e/t.resolution,s=(t.boundingBox.yMax-t.boundingBox.yMin+t.underlineThickness)*r,o=[];let a=0,l=0;for(let c=0;c<n.length;c++){const u=n[c];if(u===`
`)a=0,l-=s;else{const h=Dp(u,r,a,l,t);a+=h.offsetX,o.push(h.path)}}return o}function Dp(i,e,t,n,r){const s=r.glyphs[i]||r.glyphs["?"];if(!s){console.error('THREE.Font: character "'+i+'" does not exists in font family '+r.familyName+".");return}const o=new Rp;let a,l,c,u,h,f,m,g;if(s.o){const v=s._cachedOutline||(s._cachedOutline=s.o.split(" "));for(let p=0,d=v.length;p<d;)switch(v[p++]){case"m":a=v[p++]*e+t,l=v[p++]*e+n,o.moveTo(a,l);break;case"l":a=v[p++]*e+t,l=v[p++]*e+n,o.lineTo(a,l);break;case"q":c=v[p++]*e+t,u=v[p++]*e+n,h=v[p++]*e+t,f=v[p++]*e+n,o.quadraticCurveTo(h,f,c,u);break;case"b":c=v[p++]*e+t,u=v[p++]*e+n,h=v[p++]*e+t,f=v[p++]*e+n,m=v[p++]*e+t,g=v[p++]*e+n,o.bezierCurveTo(h,f,m,g,c,u);break}}return{offsetX:s.ha*e,path:o}}Et.enabled=!1;var Wa=document.getElementsByClassName("currentList");for(var kr=0;kr<Wa.length;kr++)Wa[kr].addEventListener("click",function(){var i=document.getElementsByClassName("active");i.length>0&&(i[0].className=i[0].className.replace(" active","")),this.className+=" active"});const Lo=document.querySelector("canvas.webgl"),fs=new Vd,Ip=new bp,Np=Ip.load("textures/matcaps/8.png"),Fp=new Pp;Fp.load("/fonts/helvetiker_regular.typeface.json",i=>{const e=new Mp({matcap:Np}),t=new hs(.3,.2,32,64);for(let n=0;n<100;n++){const r=new jt(t,e);r.position.x=(Math.random()-.5)*10,r.position.y=(Math.random()-.5)*10,r.position.z=(Math.random()-.5)*10,r.rotation.x=Math.random()*Math.PI,r.rotation.y=Math.random()*Math.PI;const s=Math.random();r.scale.set(s,s,s),fs.add(r)}});const Nt={width:window.innerWidth,height:window.innerHeight};window.addEventListener("resize",()=>{Nt.width=window.innerWidth,Nt.height=window.innerHeight,cn.aspect=Nt.width/Nt.height,cn.updateProjectionMatrix(),ni.setSize(Nt.width,Nt.height),ni.setPixelRatio(Math.min(window.devicePixelRatio,2))});const cn=new Tt(75,Nt.width/Nt.height,.1,100);cn.position.x=1;cn.position.y=1;cn.position.z=2;fs.add(cn);const ds=new Cp(cn,Lo);ds.enableDamping=!0;ds.autoRotate=!0;const ni=new To({canvas:Lo});ni.outputColorSpace=Ut;ni.setSize(Nt.width,Nt.height);ni.setPixelRatio(Math.min(window.devicePixelRatio,2));const Op=new wp,Uo=()=>{Op.getElapsedTime(),ds.update(),ni.render(fs,cn),window.requestAnimationFrame(Uo)};Uo();
